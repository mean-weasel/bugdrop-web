...
`)}async function tr(e,t){let n=t.fontEmbedCSS!=null?t.fontEmbedCSS:t.skipFonts?null:await er(e,t);if(n){let r=document.createElement("style"),o=document.createTextNode(n);r.appendChild(o),e.firstChild?e.insertBefore(r,e.firstChild):e.appendChild(r)}}async function fa(e,t={}){let{width:n,height:r}=Gt(e,t),o=await We(e,t,!0);return await tr(o,t),await Jt(o,t),Xn(o,t),await Hn(o,n,r)}async function ha(e,t={}){let{width:n,height:r}=Gt(e,t),o=await fa(e,t),i=await Ce(o),a=document.createElement("canvas"),s=a.getContext("2d"),l=t.pixelRatio||Bn(),c=t.canvasWidth||n,d=t.canvasHeight||r;return a.width=c*l,a.height=d*l,t.skipAutoScale||_n(a),a.style.width=`${c}`,a.style.height=`${d}`,t.backgroundColor&&(s.fillStyle=t.backgroundColor,s.fillRect(0,0,a.width,a.height)),s.drawImage(i,0,0,a.width,a.height),a}async function nr(e,t={}){return(await ha(e,t)).toDataURL()}var rr={triggerLabel:"Feedback",triggerAriaLabel:"Fehler melden oder Feedback senden",dismissButtonAriaLabel:"Feedback-Button ausblenden",pullTabAriaLabel:"Feedback-Button anzeigen",dragHandleTitle:"Feedback-Button verschieben",installRequiredTitle:"Installation erforderlich",connectionErrorTitle:"Verbindungsfehler",installRequiredMessage:"BugDrop ben\xF6tigt die Installation der GitHub-App, um Issues zu erstellen.",apiUnreachableMessage:"Die BugDrop-API ist nicht erreichbar. \xDCberpr\xFCfen Sie Ihre Netzwerkverbindung oder die URL des Script-Tags.",installApp:"App installieren",welcomeTitle:"Teilen Sie Ihr Feedback",welcomeHeadline:"Helfen Sie uns, besser zu werden, indem Sie Ihre Meinung teilen",welcomeBodyLine1:"Melden Sie Fehler, schlagen Sie Funktionen vor oder hinterlassen Sie Feedback.",welcomeBodyLine2:"Sie k\xF6nnen optional kommentierte Screenshots hinzuf\xFCgen.",getStarted:"Los geht\u2019s",feedbackFormTitle:"Feedback senden",categoryLabel:"Kategorie",categoryBug:"Fehler",categoryFeature:"Funktion",categoryQuestion:"Frage",nameLabel:"Name",namePlaceholder:"Ihr Name",emailLabel:"E-Mail",emailPlaceholder:"ihre@email.de",titleLabel:"Titel",titlePlaceholder:"Kurze Beschreibung des Problems oder Vorschlags",descriptionLabel:"Beschreibung",descriptionPlaceholder:"Geben Sie weitere Details, Schritte zur Reproduktion oder Kontext an...",screenshotAutoNote:"Diese Website h\xE4ngt beim Absenden automatisch einen Screenshot der gesamten Seite an, ohne eine Vorschau anzuzeigen. \xDCberpr\xFCfen Sie Ihre Seite vor dem Senden auf sensible Informationen.",screenshotAutoRedactionNote:"Einige von dieser Website als privat markierte Felder k\xF6nnen auf unterst\xFCtzten Seiten optisch maskiert werden, nicht markierte sensible Informationen k\xF6nnen jedoch weiterhin enthalten sein.",screenshotRequiredNote:"\u{1F4F8} Vor dem Absenden ist ein Screenshot erforderlich.",includeScreenshotLabel:"\u{1F4F8} Screenshot hinzuf\xFCgen",sendConsoleLogsLabel:"Konsolenprotokolle mitsenden",uploadsAriaLabel:"Uploads",uploadFilesAriaLabel:"Dateien hochladen",uploadButton:"Hochladen",uploadTooMany:e=>`Laden Sie bis zu ${e} Dateien hoch. Entfernen Sie eine Datei, bevor Sie eine weitere hinzuf\xFCgen.`,uploadUnsupportedType:"Dieser Dateityp wird nicht unterst\xFCtzt. Laden Sie ein Bild, ein PDF oder ein kurzes Video hoch.",uploadTooLarge:e=>`Die Datei ist zu gro\xDF. Laden Sie Dateien bis zu ${e} hoch.`,uploadReadError:"Diese Datei konnte nicht gelesen werden. Versuchen Sie es mit einer anderen.",removeAttachmentAriaLabel:e=>`${e} entfernen`,cancel:"Abbrechen",continueButton:"Weiter",submit:"Absenden",submittingTitle:"Wird gesendet...",creatingIssue:"Issue wird erstellt...",rateLimited:e=>`Zu viele \xDCbermittlungen. Bitte versuchen Sie es in ${e} Minute${e===1?"":"n"} erneut.`,submitFailedFallback:"Senden fehlgeschlagen",networkError:"Netzwerkfehler. Bitte \xFCberpr\xFCfen Sie Ihre Verbindung.",submissionFailedTitle:"Senden fehlgeschlagen",tryAgain:"Erneut versuchen",successTitle:"Feedback gesendet!",issueCreated:e=>`Issue ${e} wurde erstellt.`,feedbackSubmittedMessage:"Ihr Feedback wurde erfolgreich gesendet.",viewOnGitHub:"Auf GitHub ansehen",done:"Fertig",captureScreenshotTitle:"Screenshot erstellen",chooseWhatToCapture:"W\xE4hlen Sie aus, was erfasst werden soll:",viewportRedactionWarning:"Bei der Erfassung des sichtbaren Bereichs \xFCber den Browser k\xF6nnen private Felder nicht automatisch maskiert werden. W\xE4hlen Sie \u201EElement ausw\xE4hlen\u201C, um die automatische Maskierung beizubehalten, oder \xFCberpr\xFCfen und verdecken Sie sensible Bereiche vor dem Senden.",redactionReviewNote:"Diese Website hat einige Felder zur Schw\xE4rzung markiert. \xDCberpr\xFCfen Sie den Screenshot vor dem Senden.",pageTooComplexViewportNote:"Diese Seite ist zu komplex f\xFCr eine vollst\xE4ndige Erfassung oder eine Bereichserfassung. Erfassen Sie stattdessen den sichtbaren Bereich oder w\xE4hlen Sie ein bestimmtes Element aus.",pageTooComplexElementNote:"Diese Seite ist zu komplex f\xFCr eine vollst\xE4ndige Erfassung oder eine Bereichserfassung. W\xE4hlen Sie stattdessen ein bestimmtes Element aus.",fullPage:"Ganze Seite",captureViewport:"Sichtbaren Bereich erfassen",selectArea:"Bereich ausw\xE4hlen",selectElement:"Element ausw\xE4hlen",skipScreenshot:"Screenshot \xFCberspringen",areaPickerInstruction:"Ziehen Sie eine Auswahl um den zu erfassenden Bereich",areaPickerRedactionInstruction:"Ziehen Sie eine Auswahl um den zu erfassenden Bereich. Markierte private Felder k\xF6nnen maskiert werden, wenn sie darin enthalten sind.",elementPickerInstruction:"Klicken Sie auf ein beliebiges Element, um es zu erfassen",elementPickerTouchInstruction:"Tippen Sie auf ein beliebiges Element, um es zu erfassen",escToCancel:"ESC zum Abbrechen",capturingTitle:"Wird erfasst...",capturingScreenshot:"Screenshot wird erfasst...",captureFailedTitle:"Erfassung fehlgeschlagen",captureFailedMessage:"Der Screenshot konnte nicht erfasst werden. Die Seite ist m\xF6glicherweise zu komplex, oder Browsereinschr\xE4nkungen greifen.",chooseAnotherMethod:"Andere Methode w\xE4hlen",maskFailureTitle:"Datenschutz-Maskierung fehlgeschlagen",maskFailureMessage:"Die automatische Schw\xE4rzung privater Felder konnte nicht angewendet werden. Zum Schutz Ihrer Daten wurde dieser Screenshot verworfen. Sie k\xF6nnen Ihr Feedback weiterhin ohne Screenshot senden.",continueWithoutScreenshot:"Ohne Screenshot fortfahren",reviewScreenshotTitle:"Screenshot \xFCberpr\xFCfen",viewportRedactionUnavailableNote:"Bei diesem \xFCber den Browser erfassten sichtbaren Bereich konnten private Felder nicht automatisch maskiert werden. \xDCberpr\xFCfen und verdecken Sie sensible Bereiche vor dem Senden.",redactionCountNote:e=>e===1?`${e} privates Element wurde zur Schw\xE4rzung in diesem Screenshot markiert. \xDCberpr\xFCfen Sie ihn vor dem Senden.`:`${e} private Elemente wurden zur Schw\xE4rzung in diesem Screenshot markiert. \xDCberpr\xFCfen Sie ihn vor dem Senden.`,redactionLimitationsNote:"BugDrop hat nur die gemessenen markierten Bereiche abgedeckt. Es untersucht keine Pixel innerhalb eingebetteter oder gerenderter Inhalte wie iFrames, Canvas, Bildern, SVGs, Videos, CSS-Hintergr\xFCnden oder benutzerdefinierten Steuerelementen. Stellen Sie vor dem Senden sicher, dass das schwarze Feld den sensiblen Bereich vollst\xE4ndig abdeckt, oder nehmen Sie den Screenshot nach Markierung eines gr\xF6\xDFeren Bereichs erneut auf.",annotationInstruction:"Stellen Sie vor dem Senden sicher, dass keine sensiblen Informationen sichtbar sind. Verdecken Sie sensible Bereiche vor dem Absenden. Schw\xE4rzungen werden dauerhaft in das hochgeladene Bild eingebettet.",selectedElementNote:e=>`Ben\xF6tigen Sie mehr umgebenden Kontext? Passen Sie ${e} im BugDrop-Script-Tag an.`,toolDraw:"Zeichnen",toolArrow:"Pfeil",toolRectangle:"Rechteck",toolRedact:"Schw\xE4rzen",undo:"R\xFCckg\xE4ngig",retake:"Erneut aufnehmen",submitFeedback:"Feedback senden",captureTimeout:"Zeit\xFCberschreitung bei der Screenshot-Erfassung \u2014 die Seite ist m\xF6glicherweise zu komplex"};var Qt={triggerLabel:"Feedback",triggerAriaLabel:"Report a bug or send feedback",dismissButtonAriaLabel:"Dismiss feedback button",pullTabAriaLabel:"Show feedback button",dragHandleTitle:"Drag feedback button",installRequiredTitle:"Install Required",connectionErrorTitle:"Connection Error",installRequiredMessage:"BugDrop requires GitHub App installation to create issues.",apiUnreachableMessage:"Unable to reach BugDrop API. Check your network connection or script tag URL.",installApp:"Install App",welcomeTitle:"Share Your Feedback",welcomeHeadline:"Help us improve by sharing your thoughts",welcomeBodyLine1:"Report bugs, suggest features, or leave feedback.",welcomeBodyLine2:"You can optionally include annotated screenshots.",getStarted:"Get Started",feedbackFormTitle:"Send Feedback",categoryLabel:"Category",categoryBug:"Bug",categoryFeature:"Feature",categoryQuestion:"Question",nameLabel:"Name",namePlaceholder:"Your name",emailLabel:"Email",emailPlaceholder:"your@email.com",titleLabel:"Title",titlePlaceholder:"Brief description of the issue or suggestion",descriptionLabel:"Description",descriptionPlaceholder:"Provide additional details, steps to reproduce, or context...",screenshotAutoNote:"This site will attach a full-page screenshot when you submit without showing a preview. Review your page for sensitive information before sending.",screenshotAutoRedactionNote:"Some fields this site marked private may be visually masked on supported pages, but unmarked sensitive information can still be included.",screenshotRequiredNote:"\u{1F4F8} A screenshot is required before submitting.",includeScreenshotLabel:"\u{1F4F8} Include a screenshot",sendConsoleLogsLabel:"Send Console Logs",uploadsAriaLabel:"Uploads",uploadFilesAriaLabel:"Upload files",uploadButton:"Upload",uploadTooMany:e=>`Upload up to ${e} files. Remove a file before adding another.`,uploadUnsupportedType:"That file type is not supported. Upload an image, PDF, or short video.",uploadTooLarge:e=>`File is too large. Upload files up to ${e}.`,uploadReadError:"Could not read that file. Try another one.",removeAttachmentAriaLabel:e=>`Remove ${e}`,cancel:"Cancel",continueButton:"Continue",submit:"Submit",submittingTitle:"Submitting...",creatingIssue:"Creating issue...",rateLimited:e=>`Too many submissions. Please try again in ${e} minute${e===1?"":"s"}.`,submitFailedFallback:"Failed to submit",networkError:"Network error. Please check your connection.",submissionFailedTitle:"Submission Failed",tryAgain:"Try Again",successTitle:"Feedback Submitted!",issueCreated:e=>`Issue ${e} has been created.`,feedbackSubmittedMessage:"Your feedback has been submitted successfully.",viewOnGitHub:"View on GitHub",done:"Done",captureScreenshotTitle:"Capture Screenshot",chooseWhatToCapture:"Choose what to capture:",viewportRedactionWarning:"Browser viewport capture cannot apply automatic private-field masks. Select Element to preserve automatic masking, or review and cover sensitive areas before sending.",redactionReviewNote:"This site marked some fields for redaction. Review the screenshot before sending.",pageTooComplexViewportNote:"This page is too complex for full-page or area capture. Capture the visible viewport or select a specific element instead.",pageTooComplexElementNote:"This page is too complex for full-page or area capture. Select a specific element instead.",fullPage:"Full Page",captureViewport:"Capture Viewport",selectArea:"Select Area",selectElement:"Select Element",skipScreenshot:"Skip Screenshot",areaPickerInstruction:"Draw a selection around the area to capture",areaPickerRedactionInstruction:"Draw a selection around the area to capture. Marked private fields may be masked if included.",elementPickerInstruction:"Click any element to capture it",elementPickerTouchInstruction:"Tap any element to capture it",escToCancel:"ESC to cancel",capturingTitle:"Capturing...",capturingScreenshot:"Capturing screenshot...",captureFailedTitle:"Capture Failed",captureFailedMessage:"Failed to capture screenshot. The page may be too complex or browser restrictions may apply.",chooseAnotherMethod:"Choose Another Method",maskFailureTitle:"Privacy masking failed",maskFailureMessage:"Automatic redaction of private fields could not be applied. To protect your data, this screenshot was discarded. You can still submit feedback without one.",continueWithoutScreenshot:"Continue without screenshot",reviewScreenshotTitle:"Review Screenshot",viewportRedactionUnavailableNote:"This browser viewport capture could not apply automatic private-field masks. Review and cover any sensitive areas before sending.",redactionCountNote:e=>`${e} private ${e===1?"item was":"items were"} marked for redaction in this screenshot. Review before sending.`,redactionLimitationsNote:"BugDrop only covered the measured marked boxes. It does not inspect pixels inside embedded or rendered content such as iframes, canvas, images, SVGs, videos, CSS backgrounds, or custom controls. Confirm the black box fully covers the sensitive region before sending, or retake after marking a larger wrapper.",annotationInstruction:"Check that no sensitive information is visible before sending. Cover sensitive areas before submitting. Redactions are baked into the uploaded image.",selectedElementNote:e=>`Need more surrounding context? Adjust ${e} on the BugDrop script tag.`,toolDraw:"Draw",toolArrow:"Arrow",toolRectangle:"Rectangle",toolRedact:"Redact",undo:"Undo",retake:"Retake",submitFeedback:"Submit Feedback",captureTimeout:"Screenshot capture timed out \u2014 the page may be too complex"};var or={triggerLabel:"Feedback",triggerAriaLabel:"Een fout melden of feedback versturen",dismissButtonAriaLabel:"Feedbackknop verbergen",pullTabAriaLabel:"Feedbackknop tonen",dragHandleTitle:"Feedbackknop verslepen",installRequiredTitle:"Installatie vereist",connectionErrorTitle:"Verbindingsfout",installRequiredMessage:"BugDrop vereist installatie van de GitHub-app om issues te kunnen aanmaken.",apiUnreachableMessage:"Kan de BugDrop-API niet bereiken. Controleer uw netwerkverbinding of de URL van de scripttag.",installApp:"App installeren",welcomeTitle:"Deel uw feedback",welcomeHeadline:"Help ons verbeteren door uw mening te delen",welcomeBodyLine1:"Meld fouten, stel functies voor of laat feedback achter.",welcomeBodyLine2:"U kunt optioneel schermafbeeldingen met aantekeningen toevoegen.",getStarted:"Aan de slag",feedbackFormTitle:"Feedback versturen",categoryLabel:"Categorie",categoryBug:"Fout",categoryFeature:"Suggestie",categoryQuestion:"Vraag",nameLabel:"Naam",namePlaceholder:"Uw naam",emailLabel:"E-mail",emailPlaceholder:"uw@email.nl",titleLabel:"Titel",titlePlaceholder:"Korte omschrijving van het probleem of de suggestie",descriptionLabel:"Omschrijving",descriptionPlaceholder:"Geef extra details, stappen om het te reproduceren of context...",screenshotAutoNote:"Deze site voegt bij het versturen automatisch een schermafbeelding van de volledige pagina toe, zonder voorbeeld. Controleer uw pagina op gevoelige informatie voordat u verstuurt.",screenshotAutoRedactionNote:"Sommige velden die deze site als priv\xE9 heeft gemarkeerd, kunnen op ondersteunde pagina\u2019s visueel worden gemaskeerd, maar niet-gemarkeerde gevoelige informatie kan nog steeds worden meegestuurd.",screenshotRequiredNote:"\u{1F4F8} Een schermafbeelding is vereist voordat u kunt versturen.",includeScreenshotLabel:"\u{1F4F8} Schermafbeelding toevoegen",sendConsoleLogsLabel:"Consolelogboeken meesturen",uploadsAriaLabel:"Uploads",uploadFilesAriaLabel:"Bestanden uploaden",uploadButton:"Uploaden",uploadTooMany:e=>`Upload maximaal ${e} bestanden. Verwijder een bestand voordat u er een toevoegt.`,uploadUnsupportedType:"Dat bestandstype wordt niet ondersteund. Upload een afbeelding, pdf of korte video.",uploadTooLarge:e=>`Het bestand is te groot. Upload bestanden tot ${e}.`,uploadReadError:"Kan dat bestand niet lezen. Probeer een ander bestand.",removeAttachmentAriaLabel:e=>`${e} verwijderen`,cancel:"Annuleren",continueButton:"Doorgaan",submit:"Versturen",submittingTitle:"Versturen...",creatingIssue:"Issue aanmaken...",rateLimited:e=>`Te veel inzendingen. Probeer het over ${e} ${e===1?"minuut":"minuten"} opnieuw.`,submitFailedFallback:"Versturen mislukt",networkError:"Netwerkfout. Controleer uw verbinding.",submissionFailedTitle:"Versturen mislukt",tryAgain:"Opnieuw proberen",successTitle:"Feedback verstuurd!",issueCreated:e=>`Issue ${e} is aangemaakt.`,feedbackSubmittedMessage:"Uw feedback is succesvol verstuurd.",viewOnGitHub:"Bekijken op GitHub",done:"Klaar",captureScreenshotTitle:"Schermafbeelding maken",chooseWhatToCapture:"Kies wat u wilt vastleggen:",viewportRedactionWarning:"Bij het vastleggen van het zichtbare deel via de browser kunnen priv\xE9velden niet automatisch worden gemaskeerd. Kies \u201CElement selecteren\u201D om automatische maskering te behouden, of controleer en dek gevoelige gebieden af voordat u verstuurt.",redactionReviewNote:"Deze site heeft enkele velden gemarkeerd voor redactie. Controleer de schermafbeelding voordat u verstuurt.",pageTooComplexViewportNote:"Deze pagina is te complex om volledig of per gebied vast te leggen. Leg het zichtbare deel vast of selecteer een specifiek element.",pageTooComplexElementNote:"Deze pagina is te complex om volledig of per gebied vast te leggen. Selecteer in plaats daarvan een specifiek element.",fullPage:"Volledige pagina",captureViewport:"Zichtbaar deel vastleggen",selectArea:"Gebied selecteren",selectElement:"Element selecteren",skipScreenshot:"Schermafbeelding overslaan",areaPickerInstruction:"Trek een selectie rond het gebied dat u wilt vastleggen",areaPickerRedactionInstruction:"Trek een selectie rond het gebied dat u wilt vastleggen. Gemarkeerde priv\xE9velden kunnen worden gemaskeerd als ze binnen de selectie vallen.",elementPickerInstruction:"Klik op een element om het vast te leggen",elementPickerTouchInstruction:"Tik op een element om het vast te leggen",escToCancel:"ESC om te annuleren",capturingTitle:"Vastleggen...",capturingScreenshot:"Schermafbeelding wordt gemaakt...",captureFailedTitle:"Opname mislukt",captureFailedMessage:"Kan geen schermafbeelding maken. De pagina is mogelijk te complex of de browser staat dit niet toe.",chooseAnotherMethod:"Kies een andere methode",maskFailureTitle:"Privacymaskering mislukt",maskFailureMessage:"Automatische redactie van priv\xE9velden kon niet worden toegepast. Om uw gegevens te beschermen is deze schermafbeelding verwijderd. U kunt uw feedback nog steeds zonder schermafbeelding versturen.",continueWithoutScreenshot:"Doorgaan zonder schermafbeelding",reviewScreenshotTitle:"Schermafbeelding controleren",viewportRedactionUnavailableNote:"Bij deze via de browser vastgelegde schermafbeelding konden priv\xE9velden niet automatisch worden gemaskeerd. Controleer en dek gevoelige gebieden af voordat u verstuurt.",redactionCountNote:e=>e===1?"1 priv\xE9-item is gemarkeerd voor redactie in deze schermafbeelding. Controleer voordat u verstuurt.":`${e} priv\xE9-items zijn gemarkeerd voor redactie in deze schermafbeelding. Controleer voordat u verstuurt.`,redactionLimitationsNote:"BugDrop heeft alleen de gemeten gemarkeerde vakken afgedekt. Het inspecteert geen pixels binnen ingesloten of gerenderde inhoud zoals iframes, canvas, afbeeldingen, SVG\u2019s, video\u2019s, CSS-achtergronden of aangepaste elementen. Controleer of het zwarte vak het gevoelige gebied volledig bedekt voordat u verstuurt, of maak de afbeelding opnieuw nadat u een groter element hebt gemarkeerd.",annotationInstruction:"Controleer of er geen gevoelige informatie zichtbaar is voordat u verstuurt. Dek gevoelige gebieden af voordat u indient. Redacties worden permanent in de ge\xFCploade afbeelding verwerkt.",selectedElementNote:e=>`Meer omringende context nodig? Pas ${e} aan op de BugDrop-scripttag.`,toolDraw:"Tekenen",toolArrow:"Pijl",toolRectangle:"Rechthoek",toolRedact:"Redigeren",undo:"Ongedaan maken",retake:"Opnieuw maken",submitFeedback:"Feedback versturen",captureTimeout:"Het maken van de schermafbeelding duurde te lang \u2014 de pagina is mogelijk te complex"};function en(e){let t=e%10,n=e%100;return t>=2&&t<=4&&(n<12||n>14)}var ir={triggerLabel:"Opinia",triggerAriaLabel:"Zg\u0142o\u015B b\u0142\u0105d lub wy\u015Blij opini\u0119",dismissButtonAriaLabel:"Ukryj przycisk opinii",pullTabAriaLabel:"Poka\u017C przycisk opinii",dragHandleTitle:"Przeci\u0105gnij przycisk opinii",installRequiredTitle:"Wymagana instalacja",connectionErrorTitle:"B\u0142\u0105d po\u0142\u0105czenia",installRequiredMessage:"BugDrop wymaga instalacji aplikacji GitHub, aby tworzy\u0107 zg\u0142oszenia.",apiUnreachableMessage:"Nie mo\u017Cna po\u0142\u0105czy\u0107 si\u0119 z API BugDrop. Sprawd\u017A po\u0142\u0105czenie sieciowe lub adres URL w tagu skryptu.",installApp:"Zainstaluj aplikacj\u0119",welcomeTitle:"Podziel si\u0119 opini\u0105",welcomeHeadline:"Pom\xF3\u017C nam si\u0119 rozwija\u0107, dziel\u0105c si\u0119 swoimi uwagami",welcomeBodyLine1:"Zg\u0142aszaj b\u0142\u0119dy, proponuj funkcje lub zostaw opini\u0119.",welcomeBodyLine2:"Opcjonalnie mo\u017Cesz do\u0142\u0105czy\u0107 zrzuty ekranu z adnotacjami.",getStarted:"Rozpocznij",feedbackFormTitle:"Wy\u015Blij opini\u0119",categoryLabel:"Kategoria",categoryBug:"B\u0142\u0105d",categoryFeature:"Propozycja",categoryQuestion:"Pytanie",nameLabel:"Imi\u0119 i nazwisko",namePlaceholder:"Twoje imi\u0119 i nazwisko",emailLabel:"E-mail",emailPlaceholder:"twoj@email.com",titleLabel:"Tytu\u0142",titlePlaceholder:"Kr\xF3tki opis problemu lub sugestii",descriptionLabel:"Opis",descriptionPlaceholder:"Podaj dodatkowe szczeg\xF3\u0142y, kroki do odtworzenia lub kontekst...",screenshotAutoNote:"Ta strona automatycznie do\u0142\u0105czy zrzut ca\u0142ej strony podczas wysy\u0142ania, bez pokazywania podgl\u0105du. Przed wys\u0142aniem sprawd\u017A, czy strona nie zawiera poufnych informacji.",screenshotAutoRedactionNote:"Niekt\xF3re pola oznaczone przez t\u0119 stron\u0119 jako prywatne mog\u0105 zosta\u0107 zamaskowane na obs\u0142ugiwanych stronach, ale nieoznaczone poufne informacje nadal mog\u0105 zosta\u0107 do\u0142\u0105czone.",screenshotRequiredNote:"\u{1F4F8} Zrzut ekranu jest wymagany przed wys\u0142aniem.",includeScreenshotLabel:"\u{1F4F8} Do\u0142\u0105cz zrzut ekranu",sendConsoleLogsLabel:"Wy\u015Blij logi konsoli",uploadsAriaLabel:"Za\u0142\u0105czniki",uploadFilesAriaLabel:"Prze\u015Blij pliki",uploadButton:"Prze\u015Blij",uploadTooMany:e=>`Mo\u017Cna przes\u0142a\u0107 maksymalnie ${e} ${en(e)?"pliki":"plik\xF3w"}. Usu\u0144 plik, aby doda\u0107 kolejny.`,uploadUnsupportedType:"Ten typ pliku nie jest obs\u0142ugiwany. Prze\u015Blij obraz, plik PDF lub kr\xF3tki film.",uploadTooLarge:e=>`Plik jest za du\u017Cy. Prze\u015Blij pliki o rozmiarze do ${e}.`,uploadReadError:"Nie uda\u0142o si\u0119 odczyta\u0107 pliku. Spr\xF3buj z innym.",removeAttachmentAriaLabel:e=>`Usu\u0144 ${e}`,cancel:"Anuluj",continueButton:"Dalej",submit:"Wy\u015Blij",submittingTitle:"Wysy\u0142anie...",creatingIssue:"Tworzenie zg\u0142oszenia...",rateLimited:e=>`Zbyt wiele zg\u0142osze\u0144. Spr\xF3buj ponownie za ${e} ${e===1?"minut\u0119":en(e)?"minuty":"minut"}.`,submitFailedFallback:"Nie uda\u0142o si\u0119 wys\u0142a\u0107",networkError:"B\u0142\u0105d sieci. Sprawd\u017A po\u0142\u0105czenie z internetem.",submissionFailedTitle:"Wysy\u0142anie nie powiod\u0142o si\u0119",tryAgain:"Spr\xF3buj ponownie",successTitle:"Opinia wys\u0142ana!",issueCreated:e=>`Utworzono zg\u0142oszenie ${e}.`,feedbackSubmittedMessage:"Twoja opinia zosta\u0142a pomy\u015Blnie wys\u0142ana.",viewOnGitHub:"Zobacz na GitHubie",done:"Gotowe",captureScreenshotTitle:"Zr\xF3b zrzut ekranu",chooseWhatToCapture:"Wybierz, co przechwyci\u0107:",viewportRedactionWarning:"Przechwytywanie widocznego obszaru przez przegl\u0105dark\u0119 nie pozwala automatycznie zamaskowa\u0107 p\xF3l prywatnych. Wybierz \u201EZaznacz element\u201D, aby zachowa\u0107 automatyczne maskowanie, albo sprawd\u017A i zakryj poufne obszary przed wys\u0142aniem.",redactionReviewNote:"Ta strona oznaczy\u0142a niekt\xF3re pola do zamazania. Sprawd\u017A zrzut ekranu przed wys\u0142aniem.",pageTooComplexViewportNote:"Ta strona jest zbyt z\u0142o\u017Cona, aby przechwyci\u0107 ca\u0142\u0105 stron\u0119 lub zaznaczony obszar. Przechwy\u0107 widoczny obszar albo zaznacz konkretny element.",pageTooComplexElementNote:"Ta strona jest zbyt z\u0142o\u017Cona, aby przechwyci\u0107 ca\u0142\u0105 stron\u0119 lub zaznaczony obszar. Zamiast tego zaznacz konkretny element.",fullPage:"Ca\u0142a strona",captureViewport:"Przechwy\u0107 widoczny obszar",selectArea:"Zaznacz obszar",selectElement:"Zaznacz element",skipScreenshot:"Pomi\u0144 zrzut ekranu",areaPickerInstruction:"Narysuj zaznaczenie wok\xF3\u0142 obszaru do przechwycenia",areaPickerRedactionInstruction:"Narysuj zaznaczenie wok\xF3\u0142 obszaru do przechwycenia. Pola oznaczone jako prywatne mog\u0105 zosta\u0107 zamaskowane, je\u015Bli znajd\u0105 si\u0119 w zaznaczeniu.",elementPickerInstruction:"Kliknij dowolny element, aby go przechwyci\u0107",elementPickerTouchInstruction:"Dotknij dowolny element, aby go przechwyci\u0107",escToCancel:"ESC, aby anulowa\u0107",capturingTitle:"Przechwytywanie...",capturingScreenshot:"Trwa przechwytywanie zrzutu ekranu...",captureFailedTitle:"Przechwytywanie nie powiod\u0142o si\u0119",captureFailedMessage:"Nie uda\u0142o si\u0119 przechwyci\u0107 zrzutu ekranu. Strona mo\u017Ce by\u0107 zbyt z\u0142o\u017Cona lub przegl\u0105darka na to nie pozwala.",chooseAnotherMethod:"Wybierz inn\u0105 metod\u0119",maskFailureTitle:"Maskowanie prywatno\u015Bci nie powiod\u0142o si\u0119",maskFailureMessage:"Nie uda\u0142o si\u0119 automatycznie zamaza\u0107 p\xF3l prywatnych. Aby chroni\u0107 Twoje dane, ten zrzut ekranu zosta\u0142 odrzucony. Nadal mo\u017Cesz wys\u0142a\u0107 opini\u0119 bez zrzutu ekranu.",continueWithoutScreenshot:"Kontynuuj bez zrzutu ekranu",reviewScreenshotTitle:"Sprawd\u017A zrzut ekranu",viewportRedactionUnavailableNote:"Na tym zrzucie przechwyconym przez przegl\u0105dark\u0119 nie uda\u0142o si\u0119 automatycznie zamaskowa\u0107 p\xF3l prywatnych. Sprawd\u017A i zakryj poufne obszary przed wys\u0142aniem.",redactionCountNote:e=>`${e} ${e===1?"prywatny element oznaczono":en(e)?"prywatne elementy oznaczono":"prywatnych element\xF3w oznaczono"} do zamazania na tym zrzucie ekranu. Sprawd\u017A przed wys\u0142aniem.`,redactionLimitationsNote:"BugDrop zakrywa tylko zmierzone, oznaczone obszary. Nie analizuje pikseli wewn\u0105trz osadzonej lub renderowanej zawarto\u015Bci, takiej jak elementy iframe, canvas, obrazy, pliki SVG, filmy, t\u0142a CSS czy niestandardowe kontrolki. Przed wys\u0142aniem upewnij si\u0119, \u017Ce czarny prostok\u0105t w pe\u0142ni zakrywa poufny obszar, albo pon\xF3w zrzut po oznaczeniu wi\u0119kszego elementu.",annotationInstruction:"Przed wys\u0142aniem sprawd\u017A, czy nie wida\u0107 poufnych informacji. Zakryj poufne obszary przed przes\u0142aniem. Zamazania s\u0105 trwale zapisywane w przesy\u0142anym obrazie.",selectedElementNote:e=>`Potrzebujesz wi\u0119cej otaczaj\u0105cego kontekstu? Dostosuj ${e} w tagu skryptu BugDrop.`,toolDraw:"Rysuj",toolArrow:"Strza\u0142ka",toolRectangle:"Prostok\u0105t",toolRedact:"Zama\u017C",undo:"Cofnij",retake:"Pon\xF3w zrzut",submitFeedback:"Wy\u015Blij opini\u0119",captureTimeout:"Up\u0142yn\u0105\u0142 limit czasu przechwytywania zrzutu ekranu \u2014 strona mo\u017Ce by\u0107 zbyt z\u0142o\u017Cona"};var ar=/[;{}<>]|\/\*|\*\/|@import|url\s*\(|<\/style/i,wa=/^-?[_a-zA-Z][_a-zA-Z0-9-]*$/,va=/^#(?:[0-9a-fA-F]{3,4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/,xa=/^(?:rgb|rgba|hsl|hsla)\(\s*[-+.\d%]+\s*(?:,\s*[-+.\d%]+\s*){2,3}\)$/i;function q(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function je(e){let t=e?.trim();if(!t||t==="none")return t;try{let n=new URL(t,window.location.href);if(n.protocol==="https:"||n.protocol==="http:")return t}catch{return}}function _(e){let t=e?.trim();if(!(!t||ar.test(t))&&(va.test(t)||xa.test(t)||wa.test(t)||typeof CSS<"u"&&CSS.supports?.("color",t)))return t}function Ae(e){let t=e?.trim();if(t){if(t==="inherit")return t;if(!ar.test(t)&&/^[\w\s"',.-]+$/.test(t))return t}}function tn(e){let t=e?.trim();if(!t||!/^(?:0|[1-9]\d*)(?:\.\d+)?$/.test(t))return;let n=Number(t);return Number.isFinite(n)?n:void 0}function J(e){let n=e?.trim()?.match(/^((?:0|[1-9]\d*)(?:\.\d+)?)(?:px)?$/);if(!n)return;let r=Number(n[1]);return Number.isFinite(r)?r:void 0}function sr(e){let t=e?.trim();if(!t||!/^[1-9]\d*$/.test(t))return;let n=Number(t);return Number.isSafeInteger(n)?n:void 0}function pt(e){if(e==="none"||e==="soft"||e==="hard")return e}var lr={en:Qt,de:rr,nl:or,pl:ir};function x(e){return q(e)}function cr(e){if(!e)return"en";let t=e.toLowerCase().split(/[-_]/)[0];return Object.prototype.hasOwnProperty.call(lr,t)?t:(console.warn(`[BugDrop] Unsupported data-locale "${e}"; falling back to English.`),"en")}var dr=Qt;function ur(e){dr=lr[e]}function p(){return dr}var Ea=15e3;function Ge(e,t){let n,r=new Promise((o,i)=>{n=setTimeout(()=>{try{t?.()}catch{}i(new Error(p().captureTimeout))},Ea)});return Promise.race([e,r]).finally(()=>clearTimeout(n))}var nn="#bugdrop-host, [data-bugdrop-owned]";function te(e){if(e instanceof ShadowRoot)return te(e.host);if(!(e instanceof Element))return!1;if(e.matches(nn)||e.closest(nn))return!0;let t=e.getRootNode();return t instanceof ShadowRoot&&te(t.host)}async function pr(e){let n=Array.from(document.querySelectorAll(nn)).map(r=>({root:r,value:r.style.getPropertyValue("visibility"),priority:r.style.getPropertyPriority("visibility")}));for(let{root:r}of n)r.style.setProperty("visibility","hidden","important");try{return await e()}finally{for(let{root:r,value:o,priority:i}of n)o?r.style.setProperty("visibility",o,i):r.style.removeProperty("visibility")}}var Pe=class extends Error{constructor(t,n){super(t,n),this.name="MaskApplicationError"}},ka="[data-bugdrop-mask], [data-bugdrop-redact], [data-bd-redact], [data-bugdrop-redacted]",Sa='input[type="password"], input[autocomplete*="cc-number"], input[autocomplete*="cc-csc"], input[autocomplete*="cc-exp"]',mr="iframe, canvas, img, svg, video",Ca=new Set(["CANVAS","IMG","SVG"]),Ta=new Set(["VIDEO"]);function mt(e){return e.matches(ka)?"developer-marked":e.matches(Sa)?"sensitive-input":null}function bt(e,t){let n=e.getBoundingClientRect();return n.width===0||n.height===0?null:{element:e,rect:{x:n.left+window.scrollX,y:n.top+window.scrollY,w:n.width,h:n.height},reason:t,strategy:"canvas-mask"}}function gt(e){let t=[],n=[];if(te(e))return{targets:t,unsupportedSurfaces:n,redactionCount:0};let r=mt(e);if(r){let o=bt(e,r);return o&&(t.push(o),ln(e,n)),{targets:t,unsupportedSurfaces:n,redactionCount:t.length}}return an(e,t,n),sn(e,t,n),{targets:t,unsupportedSurfaces:n,redactionCount:t.length}}function br(e=document.body,t){let n=gt(e).targets.map(r=>r.rect);return t?n.filter(r=>rn(r,t)).length:n.length}function gr(e,t){let n=t?e.targets.filter(o=>rn(o.rect,t)):e.targets,r=t?e.unsupportedSurfaces.filter(o=>rn(o.rect,t)):e.unsupportedSurfaces;return{count:n.length,hasLimitations:r.length>0}}function rn(e,t){return e.x<t.x+t.width&&e.x+e.w>t.x&&e.y<t.y+t.height&&e.y+e.h>t.y}function an(e,t,n){for(let r of Array.from(e.children)){if(te(r))continue;let o=mt(r);if(o){let i=bt(r,o);i&&(t.push(i),ln(r,n));continue}an(r,t,n),sn(r,t,n)}}function sn(e,t,n){let r=e.shadowRoot;if(r)for(let o of Array.from(r.children)){let i=mt(o);if(i){let a=bt(o,i);a&&(t.push(a),ln(o,n));continue}an(o,t,n),sn(o,t,n)}}function ln(e,t){on(e,t);for(let n of Array.from(e.querySelectorAll(mr)))on(n,t);fr(e,t)}function on(e,t){let n=La(e);if(!n)return;let r=bt(e,mt(e)??"developer-marked");r&&t.push({tagName:e.tagName,reason:n,rect:r.rect})}function La(e){let t=e.tagName.toUpperCase();return t==="IFRAME"?"embedded-document":Ca.has(t)?"pixel-content":Ta.has(t)?"media-content":null}function fr(e,t){let n=e.shadowRoot;if(n)for(let r of Array.from(n.querySelectorAll(mr)))on(r,t);for(let r of Array.from(e.children))fr(r,t)}function Fa(e,t,n,r,o){let i=(e.x-n.x)*t,a=(e.y-n.y)*t,s=e.w*t,l=e.h*t,c=Math.max(0,Math.floor(i)-1),d=Math.max(0,Math.floor(a)-1),u=Math.min(r,Math.ceil(i+s)+1),f=Math.min(o,Math.ceil(a+l)+1);return{x:c,y:d,w:u-c,h:f-d}}async function cn(e,t,n,r={x:0,y:0}){if(t.length===0)return e;let o=await Aa(e),i=document.createElement("canvas");i.width=o.naturalWidth||o.width,i.height=o.naturalHeight||o.height;let a=i.getContext("2d");if(!a)throw new Pe("Failed to get canvas context for privacy masking");a.drawImage(o,0,0),a.fillStyle="#000";for(let s of t){let l=Fa(s,n,r,i.width,i.height);l.w>0&&l.h>0&&a.fillRect(l.x,l.y,l.w,l.h)}return i.toDataURL("image/png")}function Aa(e){return new Promise((t,n)=>{let r=new Image;r.onload=()=>t(r),r.onerror=()=>n(new Pe("Failed to load image for privacy masking")),r.src=e})}var Xe="#14b8a6";function ge(e){return e||Xe}function ft(e){return`color-mix(in srgb, ${e} 85%, black)`}function hr(e){return e??0}function un(){return pr(Pa)}function Pa(){if(window.__bugdropMockViewportCapture)return window.__bugdropMockViewportCapture();if(!navigator.mediaDevices?.getDisplayMedia)return Promise.reject(new Error("Screen Capture API is not available"));let e={video:{displaySurface:"browser"},audio:!1,preferCurrentTab:!0},t=new AbortController,n=navigator.mediaDevices.getDisplayMedia(e).then(r=>Ra(r,t.signal));return Ge(n,()=>t.abort())}async function Ra(e,t){let n=document.createElement("video");n.muted=!0,n.playsInline=!0;let r=Da(e,n,t);try{Ma(e),dn(t),await Ia(n,e,t,r),dn(t);let o=n.videoWidth||window.innerWidth,i=n.videoHeight||window.innerHeight;if(!o||!i)throw new Error("Screen capture stream did not provide a video frame");let a=document.createElement("canvas");a.width=o,a.height=i;let s=a.getContext("2d");if(!s)throw new Error("Failed to get canvas context");return s.drawImage(n,0,0,o,i),a.toDataURL("image/png")}finally{r.cleanup()}}function Ma(e){let[t]=e.getVideoTracks(),n=t?.getSettings().displaySurface;if(n&&n!=="browser")throw new Error("Please choose the current browser tab for viewport capture")}function Da(e,t,n){let r=!1,o=!1,i=[],a=()=>{if(!r){r=!0;for(let l of i.splice(0))l();for(let l of e.getTracks())l.stop();o&&(t.srcObject=null)}},s=()=>a();return n.addEventListener("abort",s,{once:!0}),i.push(()=>n.removeEventListener("abort",s)),n.aborted&&a(),{attachStream:()=>{r||(t.srcObject=e,o=!0)},cleanup:a}}async function Ia(e,t,n,r){r.attachStream(),dn(n);let o;try{o=e.play()}catch{o=Promise.resolve()}await za(o.then(()=>{},()=>{}),n),!(typeof e.requestVideoFrameCallback=="function"&&(await $a(e,n),e.readyState>=HTMLMediaElement.HAVE_CURRENT_DATA))&&(e.readyState>=HTMLMediaElement.HAVE_CURRENT_DATA||await Oa(e,n))}function za(e,t){return t.aborted?Promise.reject(Ke()):new Promise((n,r)=>{let o=()=>{t.removeEventListener("abort",o),r(Ke())};t.addEventListener("abort",o,{once:!0}),e.then(i=>{t.removeEventListener("abort",o),n(i)},i=>{t.removeEventListener("abort",o),r(i)})})}function $a(e,t){return new Promise((n,r)=>{let o,i=setTimeout(()=>s(n),250),a=()=>s(()=>r(Ke())),s=l=>{clearTimeout(i),t.removeEventListener("abort",a),o!==void 0&&e.cancelVideoFrameCallback?.(o),o=void 0,l()};t.addEventListener("abort",a,{once:!0}),o=e.requestVideoFrameCallback?.(()=>s(n)),t.aborted&&a()})}function Oa(e,t){return new Promise((n,r)=>{let o=setTimeout(()=>l(n),250),i=()=>l(n),a=()=>l(()=>r(new Error("Failed to load screen capture stream"))),s=()=>l(()=>r(Ke())),l=c=>{clearTimeout(o),e.removeEventListener("loadeddata",i),e.removeEventListener("canplay",i),e.removeEventListener("error",a),t.removeEventListener("abort",s),c()};e.addEventListener("loadeddata",i),e.addEventListener("canplay",i),e.addEventListener("error",a),t.addEventListener("abort",s,{once:!0}),t.aborted&&s()})}function dn(e){if(e.aborted)throw Ke()}function Ke(){return new DOMException("Viewport capture aborted","AbortError")}var yr=3e3,wr="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==",Na=1e4,Ba=yr;function Re(){return document.body.querySelectorAll("*").length}function ne(){return Re()>=_a()}function _a(e=navigator.userAgent){return Ha(e)?Ba:Na}function Ha(e=navigator.userAgent){return/Safari\//.test(e)&&!/(Chrome|Chromium|CriOS|FxiOS|Edg|EdgiOS|OPR|Opera)\//.test(e)}function vr(e,t){if(e&&Re()>yr)return 1;let n=t??2;return Math.max(window.devicePixelRatio||1,n)}function xr(){let e=window.isSecureContext||location.protocol==="https:"||location.hostname==="localhost"||location.hostname==="127.0.0.1",t=typeof window.__bugdropMockViewportCapture=="function"||typeof navigator.mediaDevices?.getDisplayMedia=="function";return e&&t}async function Er(e,t,n={}){let r=e||document.body,o=!e,i=ht(e||document.body),a=n.highlightElement&&r.contains(n.highlightElement)?ht(n.highlightElement):null,s=n.pixelRatio??vr(o,t),l=e?window.getComputedStyle(e):null,c=Cr(),d={cacheBust:!1,imagePlaceholder:wr,pixelRatio:s,filter:Sr,...l&&(l.marginLeft!=="0px"||l.marginRight!=="0px")?{style:{margin:`${l.marginTop} 0px ${l.marginBottom} 0px`}}:{}},u=gt(r),f=e?{x:i.x,y:i.y}:{x:0,y:0},m=c(r,d),g=await Ge(m),h=await cn(g,u.targets.map(E=>E.rect),s,f);return yt(a?await Tr(h,a,i,n.highlightStyle):h,u)}async function kr(e,t,n={}){let r=n.pixelRatio??vr(!0,t),o={x:e.x,y:e.y,w:e.width,h:e.height},i=n.highlightElement&&document.body.contains(n.highlightElement)?ht(n.highlightElement):null,a=Cr(),s={cacheBust:!1,imagePlaceholder:wr,pixelRatio:r,width:e.width,height:e.height,style:{transform:`translate(${-e.x}px, ${-e.y}px)`,transformOrigin:"top left",width:`${document.documentElement.scrollWidth}px`,height:`${document.documentElement.scrollHeight}px`},filter:Sr},l=gt(document.body),c=await Ge(a(document.body,s)),d=await cn(c,l.targets.map(u=>u.rect),r,{x:e.x,y:e.y});return yt(i?await Tr(d,i,o,n.highlightStyle):d,l,e)}function Me(e,t){return br(e??document.body,t)}function Sr(e){return!(te(e)||Va(e)&&Ua(e))}function Va(e){return e.tagName?.toUpperCase()==="IMG"}function Ua(e){let t=(e.ownerDocument.defaultView??window).getComputedStyle(e);if(t.display==="none"||t.visibility==="hidden")return!0;let n=e.getBoundingClientRect();return n.width<=0||n.height<=0}function Cr(){return nr}function yt(e,t,n){return{dataUrl:e,redaction:gr(t,n)}}async function Tr(e,t,n,r={}){if(t.w<=0||t.h<=0)return e;let o=await Ga(e),i=o.naturalWidth||o.width,a=o.naturalHeight||o.height,s=i/Math.max(1,n.w),l=a/Math.max(1,n.h),c=Math.max(1,(s+l)/2),d=Wa(r.borderWidth,c),f=2*c+d/2,m=(t.x-n.x)*s-f,g=(t.y-n.y)*l-f,h=t.w*s+f*2,E=t.h*l+f*2,C=Math.max(0,Math.ceil(-m)),F=Math.max(0,Math.ceil(-g)),P=Math.max(0,Math.ceil(m+h-i)),L=Math.max(0,Math.ceil(g+E-a)),D=document.createElement("canvas");D.width=i+C+P,D.height=a+F+L;let v=D.getContext("2d");if(!v)throw new Error("Failed to get canvas context for selected element highlight");v.drawImage(o,C,F);let A=Math.round(m+C),z=Math.round(g+F),I=Math.round(h),$=Math.round(E),T=ja(r.radius,c),N=ge(r.accentColor);return qa(v,A,z,I,$,T),v.lineWidth=d,v.strokeStyle=N,v.stroke(),D.toDataURL("image/png")}function qa(e,t,n,r,o,i){let a=Math.max(0,Math.min(i,r/2,o/2));e.beginPath(),e.moveTo(t+a,n),e.lineTo(t+r-a,n),e.quadraticCurveTo(t+r,n,t+r,n+a),e.lineTo(t+r,n+o-a),e.quadraticCurveTo(t+r,n+o,t+r-a,n+o),e.lineTo(t+a,n+o),e.quadraticCurveTo(t,n+o,t,n+o-a),e.lineTo(t,n+a),e.quadraticCurveTo(t,n,t+a,n),e.closePath()}function Wa(e,t){let n=Number.parseFloat(e||"3");return Math.max(1,Math.round((Number.isFinite(n)?n:3)*t))}function ja(e,t){let n=Number.parseFloat(e||"6");return Math.max(0,Math.round((Number.isFinite(n)?n:6)*t))}function ht(e){let t=e.getBoundingClientRect();return{x:t.left+window.scrollX,y:t.top+window.scrollY,w:t.width,h:t.height}}function Ga(e){return new Promise((t,n)=>{let r=new Image;r.onload=()=>t(r),r.onerror=()=>n(new Error("Failed to load image for selected element highlight")),r.src=e})}function wt(e){let t=e?.theme==="dark",n=J(e?.radius),r=J(e?.borderWidth),o=Ae(e?.font);return{accent:ge(_(e?.accentColor)),fontFamily:e?.font==="inherit"?"system-ui, sans-serif":o||"'Space Grotesk', system-ui, sans-serif",radius:n!==void 0?`${n}px`:"6px",bw:r!==void 0?String(r):"3",tooltipBg:_(e?.bgColor)||(t?"#0f172a":"#1a1a1a"),tooltipText:_(e?.textColor)||"#f1f5f9",tooltipBorder:_(e?.borderColor)||(t?"#334155":"#333")}}var Xa=new Set(["alert","alertdialog","application","article","banner","button","cell","checkbox","columnheader","combobox","complementary","contentinfo","definition","dialog","directory","document","feed","figure","form","grid","gridcell","group","heading","img","link","list","listbox","listitem","log","main","marquee","math","menu","menubar","menuitem","menuitemcheckbox","menuitemradio","meter","navigation","none","note","option","presentation","progressbar","radio","radiogroup","region","row","rowgroup","rowheader","scrollbar","search","searchbox","separator","slider","spinbutton","status","switch","tab","table","tablist","tabpanel","term","textbox","timer","toolbar","tooltip","tree","treegrid","treeitem"]),Ka=new Set(["button","checkbox","link","menuitem","menuitemcheckbox","menuitemradio","option","radio","searchbox","switch","tab","textbox"]),Ya=new Set(["button","input","select","textarea"]);function Lr(e){return Za(e)??e}function Za(e){let{body:t,documentElement:n}=e.ownerDocument,r=e;for(;r&&r!==t&&r!==n;){if(Ja(r))return r;r=r.parentElement}return null}function Ja(e){if(e.getAttribute("aria-disabled")==="true")return!1;let t=e.tagName.toLowerCase();if(t==="a")return e.hasAttribute("href");if(Ya.has(t))return!("disabled"in e&&e.disabled);if(t==="summary")return!0;let n=Qa(e);if(n&&Ka.has(n))return!0;let r=e.getAttribute("tabindex");return r!==null&&Number.parseInt(r,10)>=0}function Qa(e){let t=e.getAttribute("role");if(!t)return null;for(let n of t.split(/\s+/)){let r=n.toLowerCase();if(Xa.has(r))return r}return null}var es=new Set(["bugdrop-element-picker-overlay","bugdrop-element-picker-highlight","bugdrop-element-picker-tooltip","bugdrop-element-picker-cancel"]);function ts(){let e=navigator.maxTouchPoints>0;return window.matchMedia&&window.matchMedia("(hover: none), (pointer: coarse), (any-pointer: coarse)").matches||e}function ns(){let e=document.createElement("div");return e.id="bugdrop-element-picker-overlay",e.style.cssText=`
  ...
  `,!t)return n.textContent=`${p().elementPickerInstruction} (${p().escToCancel})`,{tooltip:n,cancelButton:null};let r=cs(e.accent);return n.append(`${p().elementPickerTouchInstruction} (`,r,")"),{tooltip:n,cancelButton:r}}function is(e,t){let n=t.getBoundingClientRect();e.style.top=`${n.top-2}px`,e.style.left=`${n.left-2}px`,e.style.width=`${n.width+4}px`,e.style.height=`${n.height+4}px`,e.style.display="block"}function as(e){e.overlay.addEventListener("pointerdown",e.onPointerDown),e.overlay.addEventListener("pointermove",e.onPointerMove),e.overlay.addEventListener("pointerup",e.onPointerUp),e.overlay.addEventListener("pointercancel",e.onPointerCancel),document.addEventListener("mousemove",e.onMouseMove,!0)}function ss(e){e.overlay.removeEventListener("pointerdown",e.onPointerDown),e.overlay.removeEventListener("pointermove",e.onPointerMove),e.overlay.removeEventListener("pointerup",e.onPointerUp),e.overlay.removeEventListener("pointercancel",e.onPointerCancel),document.removeEventListener("mousemove",e.onMouseMove,!0)}function Fr(e,t){return new Promise(n=>{setTimeout(()=>{t?.aborted?n(null):ls(n,e,t)},50)})}function ls(e,t,n){let{accent:r,fontFamily:o,radius:i,bw:a,tooltipBg:s,tooltipText:l,tooltipBorder:c}=wt(t),d=ns();document.body.appendChild(d);let u=rs({accent:r,bw:a,radius:i});document.body.appendChild(u);let{tooltip:f,cancelButton:m}=os({accent:r,fontFamily:o,radius:i,bw:a,tooltipBg:s,tooltipText:l,tooltipBorder:c},ts());document.body.appendChild(f);let g=null,h=null,E=!1,C;function F(y){return y===d||y===u||y===f||es.has(y.id)}function P(y,Y){let ee=d.style.pointerEvents;return d.style.pointerEvents="none",(()=>{try{return document.elementsFromPoint(y,Y)}finally{d.style.pointerEvents=ee}})().find($n=>!(F($n)||te($n)))}function L(y,Y,ee){let ke=P(y,Y);return ke?Lr(ke):ee}function D(y){g=L(y.clientX,y.clientY,g),g&&is(u,g)}function v(y,Y,ee=!1){g=L(y,Y,g),A(g,ee)}function A(y,Y=!1){E||(E=!0,U(Y),e(y))}let z=()=>A(null);function I(y){h!==null||!y.isPrimary||(y.preventDefault(),y.stopPropagation(),h=y.pointerId,d.setPointerCapture?.(y.pointerId),g=L(y.clientX,y.clientY,g))}function $(y){h!==null&&y.pointerId!==h||(y.preventDefault(),y.stopPropagation(),D(y))}function T(y){h!==null&&y.pointerId!==h||(y.preventDefault(),y.stopPropagation(),h=null,d.releasePointerCapture?.(y.pointerId),v(y.clientX,y.clientY,!0))}function N(y){y.pointerId===h&&(h=null,d.releasePointerCapture?.(y.pointerId))}function w(y){if(E){if(document.removeEventListener("click",w,!0),te(y.target))return;y.preventDefault(),y.stopImmediatePropagation();return}if(y.preventDefault(),y.stopImmediatePropagation(),y.target instanceof Element&&y.target.id==="bugdrop-element-picker-cancel"){A(null);return}v(y.clientX,y.clientY)}function b(y){y.target instanceof Element&&y.target.id==="bugdrop-element-picker-cancel"||(y.type==="pointerdown"&&I(y),y.type==="pointermove"&&$(y),y.type==="pointerup"&&T(y),y.type==="pointercancel"&&N(y),y.preventDefault(),y.stopImmediatePropagation())}function R(y){y.key==="Escape"&&A(null)}function O(y){y.preventDefault(),y.stopPropagation(),A(null)}function U(y=!1){C!==void 0&&(window.clearTimeout(C),C=void 0),ss({overlay:d,onPointerDown:I,onPointerMove:$,onPointerUp:T,onPointerCancel:N,onMouseMove:D}),y?C=window.setTimeout(()=>{document.removeEventListener("click",w,!0),C=void 0},1e3):document.removeEventListener("click",w,!0),document.removeEventListener("keydown",R),ae(),m?.removeEventListener("click",O),n?.removeEventListener("abort",z),d.remove(),u.remove(),f.remove(),document.body.style.cursor=""}function B(){window.addEventListener("pointerdown",b,!0),window.addEventListener("pointermove",b,!0),window.addEventListener("pointerup",b,!0),window.addEventListener("pointercancel",b,!0)}function ae(){window.removeEventListener("pointerdown",b,!0),window.removeEventListener("pointermove",b,!0),window.removeEventListener("pointerup",b,!0),window.removeEventListener("pointercancel",b,!0)}document.body.style.cursor="crosshair",B(),as({overlay:d,onPointerDown:I,onPointerMove:$,onPointerUp:T,onPointerCancel:N,onMouseMove:D}),document.addEventListener("click",w,!0),document.addEventListener("keydown",R),m?.addEventListener("click",O),n?.addEventListener("abort",z,{once:!0})}function cs(e){let t=document.createElement("button");return t.id="bugdrop-element-picker-cancel",t.type="button",t.textContent=p().cancel,t.style.cssText=`
    align-items: center;
    appearance: none;
    background: transparent;
    border: 0;
    ...
    white-space: nowrap;
    width: auto;
  `,t}var Ar=10;function Pr(e,t,n){return new Promise(r=>{setTimeout(()=>{n?.aborted?r(null):ds(r,e,t,n)},50)})}function ds(e,t,n,r){let{accent:o,fontFamily:i,radius:a,bw:s,tooltipBg:l,tooltipText:c,tooltipBorder:d}=wt(t),u=us();document.body.appendChild(u);let f=ps({accent:o,bw:s,radius:a});document.body.appendChild(f);let m=n?.redactionsAvailable?p().areaPickerRedactionInstruction:p().areaPickerInstruction,g=bs(),h=ms({accent:o,fontFamily:i,radius:a,bw:s,tooltipBg:l,tooltipText:c,tooltipBorder:d},m,g);document.body.appendChild(h);let E=h.querySelector("#bugdrop-area-picker-cancel"),C=0,F=0,P=!1,L=null;function D(b,R,O,U){let B=Math.min(b,O),ae=Math.min(R,U),y=Math.abs(O-b),Y=Math.abs(U-R);f.style.left=`${B}px`,f.style.top=`${ae}px`,f.style.width=`${y}px`,f.style.height=`${Y}px`,f.style.display="block";let ee=B+y,ke=ae+Y;u.style.clipPath=`polygon(
      0% 0%, 0% 100%, ${B}px 100%, ${B}px ${ae}px,
      ${ee}px ${ae}px, ${ee}px ${ke}px,
      ${B}px ${ke}px, ${B}px 100%, 100% 100%, 100% 0%
    )`}function v(b){L!==null||!b.isPrimary||(b.preventDefault(),C=b.clientX,F=b.clientY,P=!0,L=b.pointerId,u.setPointerCapture?.(b.pointerId))}function A(b){!P||b.pointerId!==L||(b.preventDefault(),D(C,F,b.clientX,b.clientY))}function z(b){if(!P||b.pointerId!==L)return;b.preventDefault(),P=!1,L=null,u.releasePointerCapture?.(b.pointerId);let R=Math.abs(b.clientX-C),O=Math.abs(b.clientY-F);if(R<Ar||O<Ar){f.style.display="none",u.style.clipPath="";return}let U=Math.min(C,b.clientX)+window.scrollX,B=Math.min(F,b.clientY)+window.scrollY;w(),e(new DOMRect(U,B,R,O))}function I(b){b.pointerId===L&&(P=!1,L=null,f.style.display="none",u.style.clipPath="")}function $(b){b.key==="Escape"&&(w(),e(null))}function T(){w(),e(null)}let N=()=>{w(),e(null)};function w(){u.removeEventListener("pointerdown",v),document.removeEventListener("pointermove",A),document.removeEventListener("pointerup",z),document.removeEventListener("pointercancel",I),document.removeEventListener("keydown",$),E?.removeEventListener("click",T),r?.removeEventListener("abort",N),u.remove(),f.remove(),h.remove()}u.addEventListener("pointerdown",v),document.addEventListener("pointermove",A),document.addEventListener("pointerup",z),document.addEventListener("pointercancel",I),document.addEventListener("keydown",$),E?.addEventListener("click",T),r?.addEventListener("abort",N,{once:!0})}function us(){let e=document.createElement("div");return e.id="bugdrop-area-picker-overlay",e.style.cssText=`
    position: fixed;
    top: 0;
    left: 0;
    width: 100%;
  ...
  `,n){let o=document.createElement("button");o.id="bugdrop-area-picker-cancel",o.type="button",o.textContent=p().cancel,o.style.cssText=`
      ...
      white-space: nowrap;
      width: auto;
    `,r.append(t," (",o,")")}else r.textContent=`${t} (${p().escToCancel})`;return r}function bs(){let e=navigator.maxTouchPoints>0;return window.matchMedia&&window.matchMedia("(hover: none), (pointer: coarse), (any-pointer: coarse)").matches||e}var pn="#ff0000",gs="#000000";var vt=Math.PI/7,Rr=2,Mr=4,xt=1;function Dr(e,t){let n=document.createElement("canvas"),r=n.getContext("2d"),o="draw",i=!1,a=[],s=null,l=!1,c=[],d=new Image;d.onload=()=>{n.width=d.width,n.height=d.height,n.style.maxWidth="100%",n.style.height="auto",n.style.cursor="crosshair",r.drawImage(d,0,0),u()},d.src=t,e.appendChild(n);function u(){c.push(r.getImageData(0,0,n.width,n.height))}function f(w){r.putImageData(w,0,0)}function m(){return c[c.length-1]??null}function g(w,b){return Math.hypot(b.x-w.x,b.y-w.y)}function h(){window.removeEventListener("mouseup",N),i=!1,a=[],s=null,l=!1}function E(){s&&f(s),h()}function C(w){let b=n.getBoundingClientRect(),R=d.width/b.width,O=d.height/b.height,U=(w.clientX-b.left)*R,B=(w.clientY-b.top)*O;return{x:Math.max(0,Math.min(n.width,U)),y:Math.max(0,Math.min(n.height,B))}}function F(){let w=n.getBoundingClientRect(),b=Math.max(n.width/w.width,n.height/w.height,1);return Math.round(5.5*b)}function P(w,b){let R=F();r.beginPath(),r.moveTo(w.x,w.y),r.lineTo(b.x,b.y),r.strokeStyle=pn,r.lineWidth=R,r.lineCap="round",r.lineJoin="round",r.stroke()}function L(w,b){P(w,b);let R=Math.atan2(b.y-w.y,b.x-w.x),O=F()*5;r.beginPath(),r.moveTo(b.x,b.y),r.lineTo(b.x-O*Math.cos(R-vt),b.y-O*Math.sin(R-vt)),r.lineTo(b.x-O*Math.cos(R+vt),b.y-O*Math.sin(R+vt)),r.closePath(),r.fillStyle=pn,r.fill()}function D(w,b){r.strokeStyle=pn,r.lineWidth=F(),r.lineCap="round",r.lineJoin="round",r.strokeRect(w.x,w.y,b.x-w.x,b.y-w.y)}function v(w,b){let R=Math.min(w.x,b.x),O=Math.min(w.y,b.y),U=Math.abs(b.x-w.x),B=Math.abs(b.y-w.y);return{x:R,y:O,width:U,height:B}}function A(w,b){let{x:R,y:O,width:U,height:B}=v(w,b),ae=Math.max(0,Math.floor(R)-xt),y=Math.max(0,Math.floor(O)-xt),Y=Math.min(n.width,Math.ceil(R+U)+xt),ee=Math.min(n.height,Math.ceil(O+B)+xt);return{x:ae,y,width:Math.max(0,Y-ae),height:Math.max(0,ee-y)}}function z(w,b){let{width:R,height:O}=A(w,b);return R>=Mr&&O>=Mr}function I(w,b){let{x:R,y:O,width:U,height:B}=A(w,b);r.fillStyle=gs,r.fillRect(R,O,U,B)}function $(w){let b=m();b&&(i=!0,a=[C(w)],s=b,l=!1,window.addEventListener("mouseup",N))}function T(w){if(!i||!s)return;let b=C(w);o==="draw"?(P(a[a.length-1],b),a.push(b),l=l||g(a[0],b)>=Rr):(f(s),o==="arrow"?L(a[0],b):o==="rect"?D(a[0],b):o==="redact"&&I(a[0],b))}function N(w){if(!i||!s){h();return}let b=C(w),R=a[0];if(!(o==="redact"?z(R,b):l||g(R,b)>=Rr)){f(s),h();return}o==="arrow"?(f(s),L(R,b)):o==="rect"?(f(s),D(R,b)):o==="redact"?(f(s),I(R,b)):o==="draw"&&!l&&P(R,b),u(),h()}return n.addEventListener("mousedown",$),n.addEventListener("mousemove",T),n.addEventListener("mouseup",N),{setTool(w){E(),o=w},undo(){if(s){E();return}if(c.length<=1)return;h(),c.pop();let w=m();w&&f(w)},getImageData(){return n.toDataURL("image/png")},destroy(){h(),n.removeEventListener("mousedown",$),n.removeEventListener("mousemove",T),n.removeEventListener("mouseup",N),n.remove()}}}function fs(){return typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}function De(e,t=fs){return e==="auto"?t():e}function Et(e){return e==="light"||e==="dark"||e==="auto"}function Ye(e,t){e.classList.toggle("bd-dark",t==="dark")}function Ze(e,t,n){let r=n==="dark",o=_(t.accentColor);if(o){let d=o;e.style.setProperty("--bd-primary",d),e.style.setProperty("--bd-primary-hover",ft(d)),e.style.setProperty("--bd-border-focus",d)}let i=_(t.bgColor);i&&(e.style.setProperty("--bd-bg-primary",i),r?(e.style.setProperty("--bd-bg-secondary",`color-mix(in srgb, ${i} 85%, white)`),e.style.setProperty("--bd-bg-tertiary",`color-mix(in srgb, ${i} 70%, white)`)):(e.style.setProperty("--bd-bg-secondary",`color-mix(in srgb, ${i} 93%, black)`),e.style.setProperty("--bd-bg-tertiary",`color-mix(in srgb, ${i} 85%, black)`)));let a=_(t.textColor);if(a){e.style.setProperty("--bd-text-primary",a);let d=i||(r?"#0f172a":"#fafaf9");e.style.setProperty("--bd-text-secondary",`color-mix(in srgb, ${a} 65%, ${d})`),e.style.setProperty("--bd-text-muted",`color-mix(in srgb, ${a} 40%, ${d})`)}let s=J(t.borderWidth)??null,l=_(t.borderColor)||null;if(s!==null||l!==null){let d=s!==null?`${s}px`:"1px",u=l||"var(--bd-border)";e.style.setProperty("--bd-border-width",d),l&&e.style.setProperty("--bd-border",u),e.style.setProperty("--bd-border-style",`var(--bd-border-width) solid ${u}`)}let c=pt(t.shadow)||null;if(c==="none")e.style.setProperty("--bd-shadow-sm","none"),e.style.setProperty("--bd-shadow-md","none"),e.style.setProperty("--bd-shadow-lg","none"),e.style.setProperty("--bd-shadow-glow","none");else if(c==="hard"){let d=l||(r?"#000":"#1a1a1a"),u=s!==null?"calc(var(--bd-border-width) + 2px)":"6px";e.style.setProperty("--bd-shadow-sm",`${d} 2px 2px 0 0`),e.style.setProperty("--bd-shadow-md",`${d} ${u} ${u} 0 0`),e.style.setProperty("--bd-shadow-lg",`${d} ${u} ${u} 0 0`),e.style.setProperty("--bd-shadow-glow","none")}}function kt(e){if(typeof window>"u"||!window.matchMedia)return typeof console<"u"&&console.warn&&console.warn('[BugDrop] window.matchMedia unavailable; data-theme="auto" will not react to OS theme changes.'),()=>{};let t=window.matchMedia("(prefers-color-scheme: dark)"),n=r=>{try{e(r.matches?"dark":"light")}catch(o){console.warn("[BugDrop] Error applying system theme change:",o)}};return t.addEventListener("change",n),()=>t.removeEventListener("change",n)}var Ie=8,hs="(hover: none), (pointer: coarse)",ys="(max-width: 640px)";function ws(e,t,n){let r=je(e);return!!(r&&r!=="none"&&r!=="#"&&n!=="never"&&(t||n==="always"))}function Ir(e,t){let n=t.position==="bottom-left"?"left: 0":"right: 0",r=De(t.theme),o=t.font==="inherit",i=t.font&&t.font!=="inherit"?Ae(t.font):null,a=o||i?"":"@import url('https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700&display=swap');",s=o?"inherit":i?`${i}, system-ui, sans-serif`:"'Space Grotesk', system-ui, sans-serif",l=J(t.radius)??null,c=l!==null?`${l}px`:"6px",d=l!==null?`${Math.round(l*1.4)}px`:"10px",u=l!==null?`${Math.round(l*2)}px`:"14px",f=J(t.borderWidth)??null,m=document.createElement("style");m.textContent=`
    ${a}
    ...
    :host {
      ...
      /* Border */
      --bd-border-width: ${f!==null?`${f}px`:"1px"};
    ...
    * {
    ...
    .bd-trigger {
      ...
      border: ${f!==null?"var(--bd-border-style)":"none"};
  ...
  `,e.appendChild(m);let g=document.createElement("div");return g.className="bd-root",Ye(g,r),Ze(g,t,r),e.appendChild(g),g}function Je(e){return`<p class="bd-redaction-note" style="margin: 0 0 12px; padding: 8px 12px; background: var(--bd-warning-bg, #fff8e1); border-radius: 6px; font-size: 13px; color: var(--bd-text-secondary);">${q(e)}</p>`}function V(e,t,n,r=!1,o=""){let i=document.createElement("div");i.className="bd-overlay";let a=["bd-modal",o].filter(Boolean).join(" "),s=r?'<div class="bd-version">BugDrop v1.56.2</div>':"";return i.innerHTML=`
    <div class="${a}">
      <div class="bd-header">
  ...
  `,e.appendChild(i),vs(i),i}function vs(e){if(typeof window.matchMedia!="function"||window.matchMedia(hs).matches)return;let t=e.querySelector(".bd-modal"),n=e.querySelector(".bd-header");if(!t||!n)return;let r=t,o=n,i=null,a=0,s=0,l=0,c=0,d=!1,u=null,f=()=>{d||(d=!0,F(),window.removeEventListener("resize",h),window.visualViewport?.removeEventListener("resize",h),u?.disconnect())};function m(v,A){let z=r.getBoundingClientRect(),I=Math.max(Ie,window.innerWidth-z.width-Ie),$=Math.max(Ie,window.innerHeight-z.height-Ie);return{left:Math.min(Math.max(v,Ie),I),top:Math.min(Math.max(A,Ie),$)}}function g(v,A){let z=m(v,A);r.style.left=`${z.left}px`,r.style.top=`${z.top}px`}function h(){if(!e.isConnected){f();return}if(!r.classList.contains("bd-modal--positioned"))return;if(window.matchMedia(ys).matches){C();return}E();let v=r.getBoundingClientRect();g(v.left,v.top)}function E(){r.style.removeProperty("width"),r.style.removeProperty("max-width");let v=r.getBoundingClientRect(),A=Math.floor(window.innerWidth*.9);r.style.width=`${Math.min(v.width,A)}px`,r.style.maxWidth="none"}function C(){r.classList.remove("bd-modal--positioned","bd-modal--dragging"),r.style.removeProperty("left"),r.style.removeProperty("top"),r.style.removeProperty("width"),r.style.removeProperty("max-width")}function F(){i!==null&&(i=null,r.classList.remove("bd-modal--dragging"),window.removeEventListener("pointermove",P),window.removeEventListener("pointerup",L),window.removeEventListener("pointercancel",D))}function P(v){i===v.pointerId&&g(l+v.clientX-a,c+v.clientY-s)}function L(v){i===v.pointerId&&F()}function D(v){i===v.pointerId&&F()}o.addEventListener("pointerdown",v=>{if(v.target.closest("button, a, input, textarea, select, label"))return;v.preventDefault();let A=r.getBoundingClientRect();i=v.pointerId,a=v.clientX,s=v.clientY,l=A.left,c=A.top,r.classList.add("bd-modal--positioned","bd-modal--dragging"),r.style.width=`${A.width}px`,r.style.maxWidth="none",g(l,c),o.setPointerCapture(v.pointerId),window.addEventListener("pointermove",P),window.addEventListener("pointerup",L),window.addEventListener("pointercancel",D)}),window.addEventListener("resize",h),window.visualViewport?.addEventListener("resize",h),e.parentNode&&(u=new MutationObserver(()=>{e.isConnected||f()}),u.observe(e.parentNode,{childList:!0}))}function zr(e,t,n,r,o="public"){return new Promise(i=>{let a=je(n),s=ws(n,r,o),l=s&&a?`<a href="${q(a)}" target="_blank" rel="noopener noreferrer" class="bd-issue-link">
        ...
        ${l}
      `:`<p class="bd-success-issue">${x(p().feedbackSubmittedMessage)}</p>`,d=V(e,p().successTitle,`
      ...
      `,!1,"bd-modal--annotator"),d=c.querySelector("#annotation-canvas"),u=Dr(d,t),f=c.querySelectorAll("[data-tool]");f.forEach(C=>{C.addEventListener("click",F=>{let P=F.currentTarget,L=P.dataset.tool;L&&(f.forEach(D=>D.classList.remove("active")),P.classList.add("active"),u.setTool(L))})}),c.querySelector('[data-action="undo"]')?.addEventListener("click",()=>u.undo());let g=c.querySelector(".bd-close"),h=c.querySelector('[data-action="retake"]'),E=c.querySelector('[data-action="done"]');g?.addEventListener("click",()=>{u.destroy(),c.remove(),o("cancel")}),h?.addEventListener("click",()=>{u.destroy(),c.remove(),o("retake")}),E?.addEventListener("click",()=>{let C=u.getImageData();u.destroy(),c.remove(),o(C)})})}async function St(e,t,n,r){return Ct(e,()=>Er(t,n,r?.captureOptions),r)}async function Or(e,t,n,r){return Ct(e,()=>kr(t,n,r?.captureOptions),r)}async function Ct(e,t,n){let r=n?.showLoading===!1?null:V(e,p().capturingTitle,`
      ...
      `,!0),r=n.querySelector(".bd-close"),o=n.querySelector('[data-action="skip"]');r?.addEventListener("click",()=>{n.remove(),t({kind:"cancelled"})}),o?.addEventListener("click",()=>{n.remove(),t({kind:"skipped"})})})}function Ss(e){return typeof e=="string"?{kind:"ok",dataUrl:e}:{kind:"ok",dataUrl:e.dataUrl,redaction:e.redaction}}function _r(e,t){let n=e.getBoundingClientRect();if(!Br(n))return e;let o=Math.max(1,window.innerWidth*window.innerHeight)*hr(t.maxViewportAreaMultiplier),i=e,a=e.parentElement;for(;a&&a!==document.body&&a!==document.documentElement;){let s=a.getBoundingClientRect(),l=s.width*s.height;Br(s)&&l<=o&&Cs(s,n)&&Ts(s,n)&&(i=a),a=a.parentElement}return i}function Br(e){return e.width>0&&e.height>0}function Cs(e,t){return e.left<=t.left&&e.top<=t.top&&e.right>=t.right&&e.bottom>=t.bottom}function Ts(e,t){let n=e.width>=t.width+160,r=e.height>=t.height+160,o=t.width*t.height,i=e.width*e.height;return n||r||i>=o*4}function Vr(e){let t=[],n=e.ownerDocument.body,r=e;if(r===n)return Tt(r);for(;r&&r!==n;){let o=Tt(r);if(r.id){o=`#${Qe(r.id)}`,t.unshift(o);break}let i=qr(r).slice(0,2);i.length&&(o+=`.${i.map(Qe).join(".")}`),t.unshift(o),r=r.parentElement}return t.join(" > ")}function Ur(e){let t=Ls(e),n=t.map(Fs),r=t.map(mn);return Ps(n,r,e)}function Ls(e){let t=[],n=e;for(;n;)t.unshift(n),n=n.parentElement;return t}function Fs(e){let t=As(e);return t.length<=128?t:mn(e)}function As(e){let t=Tt(e);e.id&&(t+=`#${Qe(e.id)}`);let n=qr(e).slice(0,3);return n.length>0&&(t+=`.${n.map(Qe).join(".")}`),e.id||(t+=Wr(e)),t}function mn(e){return`${Tt(e)}${Wr(e)}`}function qr(e){return Array.from(e.classList).filter(Boolean)}function Tt(e){return Qe(e.localName||e.tagName.toLowerCase())}function Ps(e,t,n){let r=e.join(" > ");return r.length<=1024?r:Hr(e,n)||Hr(t,n)||mn(n)}function Hr(e,t){for(let n=e.length-1;n>=0;n-=1){let r=e.slice(n).join(" > ");if(!(r.length>1024)&&Rs(r,t))return r}return null}function Rs(e,t){try{return t.ownerDocument.querySelector(e)===t}catch{return!1}}function Wr(e){let t=Ms(e);return t>1||Ds(e)?`:nth-of-type(${t})`:""}function Ms(e){let t=1,n=e.previousElementSibling;for(;n;)n.tagName===e.tagName&&(t+=1),n=n.previousElementSibling;return t}function Ds(e){let t=e.previousElementSibling;for(;t;){if(t.tagName===e.tagName)return!0;t=t.previousElementSibling}for(t=e.nextElementSibling;t;){if(t.tagName===e.tagName)return!0;t=t.nextElementSibling}return!1}function Qe(e){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):Is(e)}function Is(e){let t="";for(let n=0;n<e.length;n+=1){let r=e.charAt(n),o=e.charCodeAt(n),i=n===0,a=n===1,s=e.charCodeAt(0);if(o===0){t+="\uFFFD";continue}if(o>=1&&o<=31||o===127||i&&o>=48&&o<=57||a&&o>=48&&o<=57&&s===45){t+=`\\${o.toString(16)} `;continue}if(i&&o===45&&e.length===1){t+="\\-";continue}if(o>=128||o===45||o===95||o>=48&&o<=57||o>=65&&o<=90||o>=97&&o<=122){t+=r;continue}t+=`\\${r}`}return t}function jr(e,t){let n=ne(),r=n&&xr(),o=t?.allowSkip!==!1,i="";return r?i=Je(p().viewportRedactionWarning):Me()>0&&(i=Je(p().redactionReviewNote)),new Promise(a=>{let s=n?`<p style="margin: 0 0 12px; padding: 8px 12px; background: var(--bd-bg-secondary, #f5f5f5); border-radius: 6px; font-size: 13px; color: var(--bd-text-secondary);">${r?x(p().pageTooComplexViewportNote):x(p().pageTooComplexElementNote)}</p>`:"",l="";n?r&&(l=`<button class="bd-btn bd-btn-primary" data-action="viewport">${x(p().captureViewport)}</button>`):l=`<button class="bd-btn bd-btn-primary" data-action="capture">${x(p().fullPage)}</button>`;let c=V(e,p().captureScreenshotTitle,`
      ...
      `),d=c.querySelector(".bd-close"),u=c.querySelector('[data-action="skip"]'),f=c.querySelector('[data-action="element"]'),m=c.querySelector('[data-action="area"]'),g=c.querySelector('[data-action="capture"]'),h=c.querySelector('[data-action="viewport"]');d?.addEventListener("click",()=>{c.remove(),a({kind:"cancel"})}),u?.addEventListener("click",()=>{c.remove(),a({kind:"skip"})}),f?.addEventListener("click",()=>{c.remove(),a({kind:"element"})}),m?.addEventListener("click",()=>{c.remove(),a({kind:"area"})}),g?.addEventListener("click",()=>{c.remove(),a({kind:"capture"})}),h?.addEventListener("click",()=>{c.remove();let E=un();E.catch(()=>{}),a({kind:"viewport",capture:E})})})}function Gr(e,t,n,r){return new Promise((o,i)=>{let a=!1,s=()=>{n.removeEventListener("abort",l)},l=()=>{a||(a=!0,zs(e),s(),o(r))};n.addEventListener("abort",l,{once:!0}),n.aborted&&l(),t.then(c=>{s(),a||o(c)},c=>{s(),a||i(c)})})}function zs(e){let t=Array.from(e.querySelectorAll(".bd-overlay"));for(let n of t)n.querySelector(".bd-close")?.click(),n.remove();document.querySelector("#bugdrop-element-picker-cancel")?.click(),document.querySelector("#bugdrop-area-picker-cancel")?.click()}function re(){return{screenshot:null,...bn(),returnToForm:!1}}function bn(){return{elementSelector:null,fullElementSelector:null}}function gn(e){return e==="explicit-skip"||e==="capture-failure-skip"}function Xr(e){throw new Error(`Unhandled screenshot choice: ${JSON.stringify(e)}`)}function fn(e){return{accentColor:e.accentColor,font:e.font,radius:e.radius,borderWidth:e.borderWidth,bgColor:e.bgColor,textColor:e.textColor,borderColor:e.borderColor,theme:e.theme}}async function Lt(e,t,n,r,o){if(o?.aborted)return{...re(),returnToForm:!0};let i=Os(e,t,n,r,o);return o?Gr(e,i,o,{...re(),returnToForm:!0}):i}async function Os(e,t,n,r,o){if(t.screenshotMode==="auto")return Ns(e,t,o);if(!n)return re();let i=t.screenshotMode==="required";for(;;){let a=await Bs(e,t,i,o);if(o?.aborted)return{...re(),returnToForm:!0};if(a.kind==="returnToForm")return{...re(),returnToForm:!0};if(a.kind==="chooseAgain")continue;if(a.kind==="empty"){if(!i&&gn(a.reason)&&r(),i)continue;return{screenshot:null,elementSelector:a.elementSelector,fullElementSelector:a.fullElementSelector,returnToForm:!1}}let s=await $r(e,a.screenshot,a.redactionCount,{redactionUnavailable:a.redactionUnavailable,...a.redactionLimitations?{redactionLimitations:!0}:{},...a.elementSelector?{selectedElementCapture:!0}:{}});if(o?.aborted)return{...re(),returnToForm:!0};if(s!=="retake")return s==="cancel"?{...re(),returnToForm:!0}:{screenshot:s,elementSelector:a.elementSelector,fullElementSelector:a.fullElementSelector,returnToForm:!1}}}async function Ns(e,t,n){if(ne())return re();let r=await St(e,void 0,t.screenshotScale,{allowChooseAgain:!1,signal:n});return r.kind==="cancelled"?{...re(),returnToForm:!0}:{screenshot:r.kind==="ok"?r.dataUrl:null,elementSelector:null,fullElementSelector:null,returnToForm:!1}}async function Bs(e,t,n,r){let o=await jr(e,{allowSkip:!n});switch(o.kind){case"cancel":return{kind:"returnToForm"};case"skip":return fe("explicit-skip");case"viewport":return _s(e,o,n,r);case"capture":return Hs(e,t,n,r);case"element":return Vs(e,t,n,r);case"area":return Us(e,t,n,r);default:return Xr(o)}}async function _s(e,t,n,r){let o=await Ct(e,t.capture,{allowSkip:!n,showLoading:!1,signal:r});return o.kind==="cancelled"?{kind:"returnToForm"}:o.kind==="choose-again"?{kind:"chooseAgain"}:o.kind==="skipped"?fe("capture-failure-skip"):{kind:"captured",screenshot:o.dataUrl,elementSelector:null,fullElementSelector:null,redactionCount:0,redactionUnavailable:!0,redactionLimitations:!1}}async function Hs(e,t,n,r){let o=await St(e,void 0,t.screenshotScale,{allowSkip:!n,signal:r});return o.kind==="cancelled"?{kind:"returnToForm"}:o.kind==="choose-again"?{kind:"chooseAgain"}:o.kind==="skipped"?fe("capture-failure-skip"):{kind:"captured",screenshot:o.dataUrl,elementSelector:null,fullElementSelector:null,redactionCount:o.redaction?.count??0,redactionUnavailable:!1,redactionLimitations:o.redaction?.hasLimitations??!1}}async function Vs(e,t,n,r){let o=await Fr(fn(t),r);if(!o)return fe("selection-cancelled");let i={elementSelector:Vr(o),fullElementSelector:Ur(o)},a=_r(o,{maxViewportAreaMultiplier:t.elementContextMaxArea}),s=await St(e,a,t.screenshotScale,{allowSkip:!n,captureOptions:{highlightElement:o,highlightStyle:{accentColor:t.accentColor,radius:t.radius,borderWidth:t.borderWidth},pixelRatio:1},signal:r});return s.kind==="cancelled"?{kind:"returnToForm"}:s.kind==="choose-again"?{kind:"chooseAgain"}:s.kind==="skipped"?fe("capture-failure-skip",i):{kind:"captured",screenshot:s.dataUrl,...i,redactionCount:s.redaction?.count??0,redactionUnavailable:!1,redactionLimitations:s.redaction?.hasLimitations??!1}}async function Us(e,t,n,r){let o=await Pr(fn(t),{redactionsAvailable:Me()>0},r);if(!o)return fe("selection-cancelled");let i=await Or(e,o,t.screenshotScale,{allowSkip:!n,signal:r});return i.kind==="cancelled"?{kind:"returnToForm"}:i.kind==="choose-again"?{kind:"chooseAgain"}:i.kind==="skipped"?fe("capture-failure-skip"):{kind:"captured",screenshot:i.dataUrl,elementSelector:null,fullElementSelector:null,redactionCount:i.redaction?.count??0,redactionUnavailable:!1,redactionLimitations:i.redaction?.hasLimitations??!1}}function fe(e,t=bn()){return{kind:"empty",reason:e,...t}}function Kr(e,t=window){if(!e)return;let n=t[e];if(typeof n!="function"){console.warn(`[BugDrop] data-auth-token-provider "${e}" must reference a function.`);return}return n}async function he(e){if(!e)return{};let t=await e();return t?{Authorization:t.startsWith("Bearer ")?t:`Bearer ${t}`}:{}}var Ft=String.raw`(?:"|')?\b(?:password|passwd|pwd|token|api[_-]?key|secret|authorization|auth|cookie)\b(?:"|')?`,qs=new RegExp(String.raw`(${Ft}\s*[:=]\s*)(["'])(?!Bearer\b)(?:\\[\s\S]|(?!\2)[^\\])*?\2`,"gi"),Ws=new RegExp(String.raw`(${Ft}\s*[:=]\s*)(["'])(?!Bearer\b)(?:\\[^\r\n]|(?!\2)[^\\\r\n])*(?=\r?\n|$)`,"gi"),js=new RegExp(String.raw`(${Ft}\s*[:=]\s*)(?:\[[^\]\r\n]*\]|\{[^\}\r\n]*\})`,"gi"),Gs=new RegExp(String.raw`(${Ft}\s*[:=]\s*)(?!Bearer\b)[^"',\s}&]+`,"gi"),Xs=/\bBearer\s+[A-Za-z0-9._~+/=-]+/gi,Ks=/\b[A-Za-z0-9+/_=-]{32,}\b/g;function Yr(e){return e.replace(Xs,"Bearer [redacted]").replace(js,"$1[redacted]").replace(qs,"$1$2[redacted]$2").replace(Ws,"$1$2[redacted]").replace(Gs,"$1[redacted]").replace(Ks,"[redacted]")}var Ys=50,Zs=1e3,Pt=[],Zr=!1;function Jr(){Zr||typeof window>"u"||typeof console>"u"||(Zr=!0,At("log"),At("info"),At("warn"),At("error"),window.addEventListener("error",e=>{hn({level:"error",message:e.message||"Unhandled error",timestamp:new Date().toISOString(),sourceUrl:e.filename||void 0,lineNumber:e.lineno||void 0,columnNumber:e.colno||void 0})}),window.addEventListener("unhandledrejection",e=>{hn({level:"error",message:`Unhandled promise rejection: ${Qr(e.reason)}`,timestamp:new Date().toISOString()})}))}function Rt(){return Pt.map(e=>({...e}))}function At(e){let t=console[e];typeof t=="function"&&(console[e]=(...n)=>{hn({level:e,message:n.map(Qr).join(" "),timestamp:new Date().toISOString(),...Js()}),t.apply(console,n)})}function hn(e){for(Pt.push({...e,message:Yr(e.message).slice(0,Zs)});Pt.length>Ys;)Pt.shift()}function Qr(e){if(e instanceof Error)return e.stack||e.message;if(typeof e=="string")return e;try{return JSON.stringify(e)}catch{return String(e)}}function Js(){let e=new Error().stack;if(!e)return{};for(let t of e.split(`
`).slice(2)){if(t.includes("console-logs"))continue;let n=t.match(/\(?((?:https?:|file:|\/)[^():]+):(\d+):(\d+)\)?$/);if(n)return{sourceUrl:n[1],lineNumber:Number(n[2]),columnNumber:Number(n[3])}}return{}}var Dt=new Set,eo=!1,yn=!1;function de(e){Dt.add(e),eo||Qs();let t=!1;return()=>{t||(t=!0,Dt.delete(e))}}function Qs(){eo=!0;let e=n=>{Mt(n)&&n.preventDefault()},t=n=>{if(!yn&&el(n)){if(n.type==="focusin"){n.stopImmediatePropagation();return}if(n.type==="focusout"){yn=!0;try{tl(n)}finally{yn=!1}n.stopImmediatePropagation();return}n.stopImmediatePropagation()}};for(let n of["dismissableLayer.pointerDownOutside","dismissableLayer.interactOutside"])document.addEventListener(n,e,!0);window.addEventListener("focusin",t,!0),window.addEventListener("focusout",t,!0)}function Mt(e){let t=e.detail?.originalEvent,n=typeof t?.composedPath=="function"?t.composedPath():typeof e.composedPath=="function"?e.composedPath():[];return Array.from(Dt).some(r=>n.includes(r)||(t?.target??e.target)===r)}function el(e){if(!(e instanceof FocusEvent)||e.type==="focusin")return Mt(e);if(e.type!=="focusout")return!1;let t=e.relatedTarget;return Array.from(Dt).some(r=>t===r||t instanceof Node&&(r.shadowRoot?.contains(t)??!1))&&!Mt(e)}function tl(e){let t=typeof e.composedPath=="function"?e.composedPath():[];for(let n of t)if(n instanceof HTMLElement&&(n.dispatchEvent(new FocusEvent("focusout",{bubbles:!1,composed:!1,relatedTarget:e instanceof FocusEvent?e.relatedTarget:null})),n===document.body))break}var It;function ze(){It?.close()}function zt(e){return It=e,()=>{It===e&&(It=void 0)}}var nl="bugdrop-variant@1";function to(e){let t=Object.freeze({kind:"variant",config:e}),n=Object.freeze([t]);return Object.freeze({id:nl,variantId:e.id,screens:n})}var se=class extends TypeError{constructor(n,r){super(r);this.fieldId=n;this.name="VariantAnswerError"}fieldId};function ye(e,t){if(!ol(t))throw new se(null,"BugDrop variant answers must be an object");let n=new Set(e.map(o=>o.id)),r=Object.keys(t).find(o=>!n.has(o));if(r)throw new se(null,`Unknown BugDrop variant answer: ${r}`)}function $e(e,t){return ye(e,t),Object.fromEntries(e.map(n=>[n.id,rl(n,t[n.id])]))}function rl(e,t){if(e.type==="shortText"||e.type==="longText"){if(t==null||t===""){if(e.required)throw ue(e,`Answer ${e.id} is required`);return""}if(typeof t!="string")throw ue(e,`Answer ${e.id} must be text`);let n=t.trim();if(e.required&&!n)throw ue(e,`Answer ${e.id} is required`);let r=e.minLength??0,o=e.maxLength??(e.type==="shortText"?500:5e3);if(n.length<r||n.length>o)throw ue(e,`Answer ${e.id} must be ${r}-${o} characters`);return n}if(e.type==="rating"){let n=e.scale??5;if(t==null||t===""){if(e.required)throw ue(e,`Answer ${e.id} is required`);return""}if(!Number.isInteger(t)||t<1||t>n)throw ue(e,`Answer ${e.id} must be a rating from 1-${n}`);return t}if(t==null||t===""){if(e.required)throw ue(e,`Answer ${e.id} is required`);return""}if(typeof t!="string"||!e.options.some(n=>n.value===t))throw ue(e,`Answer ${e.id} must be a configured choice`);return t}function ue(e,t){return new se(e.id,t)}function ol(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function pe(e,t){let n=document.createElement("div");n.className="bdv-field",n.dataset.bugdropField=e.id,n.dataset.span=String(e.layout?.span??1);let r=`${t}-${e.id}`,o=`${r}-label`,i=`${r}-help`,a=`${r}-error`,s=document.createElement("label");if(s.className="bdv-label",s.id=o,s.htmlFor=r,s.textContent=e.label,e.required){let d=document.createElement("span");d.className="bdv-required",d.textContent=" *",d.setAttribute("aria-hidden","true"),s.appendChild(d)}n.appendChild(s);let l=[];if(e.helpText){let d=document.createElement("div");d.className="bdv-help",d.id=i,d.textContent=e.helpText,n.appendChild(d),l.push(i)}let c=document.createElement("div");return c.className="bdv-error",c.id=a,c.hidden=!0,c.setAttribute("aria-live","polite"),n.appendChild(c),l.push(a),{wrapper:n,label:s,controlId:r,labelId:o,describedBy:l.join(" ")||null,setError(d,u){c.textContent=u??"",c.hidden=!u,u?d.setAttribute("aria-invalid","true"):d.removeAttribute("aria-invalid")}}}function $t(e,t,n){e.id=n.controlId,e.className="bdv-input",e.required=t.required??!1,e.setAttribute("aria-required",String(t.required??!1)),n.describedBy&&e.setAttribute("aria-describedby",n.describedBy),t.placeholder&&(e.placeholder=t.placeholder),e.minLength=t.minLength??0,e.maxLength=t.maxLength??(t.type==="shortText"?500:5e3),n.wrapper.insertBefore(e,n.wrapper.querySelector(".bdv-error"))}function no(e,t){let n=pe(e,t),r=document.createElement("textarea");return r.rows=e.rows??4,$t(r,e,n),{field:e,element:n.wrapper,getValue:()=>r.value,setValue(o){r.value=typeof o=="string"?o:""},setError:o=>n.setError(r,o),setDisabled:o=>{r.disabled=o},focus:()=>r.focus(),dispose(){}}}function ro(e,t){let n=pe(e,t),r=e.scale??5,o=document.createElement("div");o.id=n.controlId,o.className="bdv-rating",o.setAttribute("role","radiogroup"),o.setAttribute("aria-labelledby",n.labelId),o.setAttribute("aria-required",String(e.required??!1)),n.describedBy&&o.setAttribute("aria-describedby",n.describedBy);let i=[],a=null,s=null,l=()=>{for(let[m,g]of i.entries()){let h=m+1,E=s===null&&a!==null&&h<=a,C=s!==null&&h<=s;g.classList.toggle("bdv-rating-option--active",E),g.classList.toggle("bdv-rating-option--preview",C),g.setAttribute("aria-checked",String(h===a)),g.tabIndex=h===(a??1)?0:-1}},c=(m,g=!1)=>{a=m,s=null,l(),g&&i[m-1]?.focus()},d=[],u=()=>{s!==null&&(s=null,l())},f=m=>{let g=m.target;g instanceof HTMLButtonElement&&i.includes(g)&&!g.disabled||u()};for(let m=1;m<=r;m+=1){let g=document.createElement("button");g.type="button",g.className="bdv-rating-option",g.setAttribute("role","radio"),g.setAttribute("aria-label",`${m} ${m===1?"star":"stars"}`),g.textContent=e.icon==="number"?String(m):"\u2605";let h=()=>c(m),E=()=>{g.disabled||(s=m,l())},C=F=>{let P=null;F.key==="ArrowRight"||F.key==="ArrowDown"?P=m===r?1:m+1:F.key==="ArrowLeft"||F.key==="ArrowUp"?P=m===1?r:m-1:F.key==="Home"?P=1:F.key==="End"?P=r:(F.key==="Enter"||F.key===" ")&&(P=m),P!==null&&(F.preventDefault(),c(P,!0))};g.addEventListener("click",h),g.addEventListener("keydown",C),g.addEventListener("pointerenter",E),d.push({button:g,click:h,keydown:C,pointerenter:E}),i.push(g),o.appendChild(g)}if(o.addEventListener("pointermove",f),o.addEventListener("pointerleave",u),n.wrapper.insertBefore(o,n.wrapper.querySelector(".bdv-error")),e.lowLabel||e.highLabel){let m=document.createElement("div");m.className="bdv-rating-labels";let g=document.createElement("span");g.textContent=e.lowLabel??"";let h=document.createElement("span");h.textContent=e.highLabel??"",m.append(g,h),n.wrapper.insertBefore(m,n.wrapper.querySelector(".bdv-error"))}return l(),{field:e,element:n.wrapper,getValue:()=>a??"",setValue(m){a=Number.isInteger(m)&&m>=1&&m<=r?m:null,s=null,l()},setError:m=>n.setError(o,m),setDisabled(m){for(let g of i)g.disabled=m;m&&u()},focus(){i[(a??1)-1]?.focus()},dispose(){u(),o.removeEventListener("pointermove",f),o.removeEventListener("pointerleave",u);for(let m of d)m.button.removeEventListener("click",m.click),m.button.removeEventListener("keydown",m.keydown),m.button.removeEventListener("pointerenter",m.pointerenter)}}}function oo(e,t){let n=pe(e,t),r=document.createElement("input");return r.type="text",$t(r,e,n),{field:e,element:n.wrapper,getValue:()=>r.value,setValue(o){r.value=typeof o=="string"?o:""},setError:o=>n.setError(r,o),setDisabled:o=>{r.disabled=o},focus:()=>r.focus(),dispose(){}}}function io(e,t){let n=pe(e,t),r=document.createElement("div");r.className=`choice ${e.display??""}`,r.setAttribute("role","radiogroup"),r.setAttribute("aria-labelledby",n.labelId),r.setAttribute("aria-required",String(e.required??!1)),n.describedBy&&r.setAttribute("aria-describedby",n.describedBy);let o=e.options.map(a=>{let s=document.createElement("label"),l=document.createElement("input");if(l.type="radio",l.name=n.controlId,l.value=a.value,s.append(l,a.label),a.description){let c=document.createElement("span");c.className="bdv-help",c.textContent=a.description,s.appendChild(c)}return r.appendChild(s),l});n.wrapper.insertBefore(r,n.wrapper.querySelector(".bdv-error"));let i=()=>r.querySelector(":checked");return{field:e,element:n.wrapper,getValue:()=>i()?.value??"",setValue(a){for(let s of o)s.checked=s.value===a},setError:a=>n.setError(r,a),setDisabled(a){for(let s of o)s.disabled=a},focus(){(i()??o[0])?.focus()},dispose(){}}}function Ot(e,t){return e.type==="shortText"?oo(e,t):e.type==="longText"?no(e,t):e.type==="rating"?ro(e,t):io(e,t)}function Nt(e){let{config:t,instanceId:n}=e,r={...e.context??{}},o={...e.initialAnswers??{}};ye(t.fields,o);let i=document.createElement("section");i.className="bdv-surface";let a=`${n}-title`;i.setAttribute("aria-labelledby",a);let s=document.createElement("div");s.className="bdv-header";let l=document.createElement("h2");if(l.className="bdv-title",l.id=a,l.textContent=t.content.title,s.appendChild(l),t.content.description){let T=document.createElement("p");T.className="bdv-description",T.textContent=t.content.description,s.appendChild(T)}i.appendChild(s);let c=document.createElement("form");c.className="bdv-form",c.noValidate=!0;let d=document.createElement("div");d.className="bdv-fields";let u=t.fields.map(T=>Ot(T,n));for(let T of u)d.appendChild(T.element);c.appendChild(d);let f=document.createElement("div");f.className="bdv-actions";let m=document.createElement("button");m.type="submit",m.className="bdv-submit",m.textContent=t.content.submitLabel??"Submit",f.appendChild(m);let g;e.cancel&&(g=document.createElement("button"),g.type="button",g.className="bdv-cancel",g.textContent=e.cancel.label,g.addEventListener("click",e.cancel.onCancel),f.appendChild(g)),c.appendChild(f);let h=document.createElement("p");h.className="bdv-status",h.setAttribute("role","status"),h.setAttribute("aria-live","polite"),c.appendChild(h),i.appendChild(c);let{success:E,successLink:C}=il(t);i.appendChild(E);let F=Q("submission"),P=!1,L=!1,D=T=>{P=T,c.setAttribute("aria-busy",String(T)),m.disabled=T,g&&(g.disabled=T);for(let N of u)N.setDisabled(T)},v=()=>{h.textContent="",h.removeAttribute("data-kind");for(let T of u)T.setError(null)},A=()=>{for(let T of u)T.setValue(o[T.field.id]??"")},z=()=>Object.fromEntries(u.map(T=>[T.field.id,T.getValue()])),I=async T=>{if(T.preventDefault(),P||L)return;v();let N;try{N=$e(t.fields,z())}catch(w){if(w instanceof se&&w.fieldId){let b=u.find(R=>R.field.id===w.fieldId);b?.setError(al(w)),b?.focus()}else h.textContent=w instanceof Error?w.message:"Please check your response.",h.dataset.kind="error";return}D(!0),h.textContent="Submitting\u2026";try{let w=await e.submit(N,{context:r,submissionId:F});if(L)return;D(!1),C.hidden=!w.isPublic,w.isPublic&&(C.href=w.issueUrl),c.hidden=!0,E.hidden=!1,E.focus(),e.onSubmitted?.(w)}catch(w){if(L)return;h.textContent=w instanceof Error?w.message:"Failed to submit feedback.",h.dataset.kind="error",D(!1)}},$=T=>{T.key==="Enter"&&T.target instanceof HTMLInputElement&&T.target.type!=="submit"&&T.preventDefault()};return c.addEventListener("submit",I),c.addEventListener("keydown",$),A(),{element:i,reset(){P||L||(F=Q("submission"),v(),A(),E.hidden=!0,C.removeAttribute("href"),c.hidden=!1)},dispose(){if(!L){L=!0,c.removeEventListener("submit",I),c.removeEventListener("keydown",$),g&&e.cancel&&g.removeEventListener("click",e.cancel.onCancel);for(let T of u)T.dispose()}}}}function Q(e){if(typeof globalThis.crypto?.randomUUID=="function")return`${e}-${globalThis.crypto.randomUUID()}`;if(typeof globalThis.crypto?.getRandomValues!="function")throw new Error("BugDrop rendered variants require a cryptographically secure random generator");let t=globalThis.crypto.getRandomValues(new Uint8Array(16));return`${e}-${Array.from(t,n=>n.toString(16).padStart(2,"0")).join("")}`}function il(e){let t=document.createElement("div");t.className="bdv-success",t.hidden=!0,t.tabIndex=-1;let n=document.createElement("h3");n.className="bdv-success-title",n.textContent=e.content.successTitle??"Thanks for your feedback!";let r=document.createElement("p");r.className="bdv-success-message",r.textContent=e.content.successMessage??"Your response was submitted.";let o=document.createElement("a");return o.className="bdv-success-link",o.textContent="View GitHub Issue",o.target="_blank",o.rel="noopener noreferrer",t.append(n,r,o),{success:t,successLink:o}}function al(e){if(!e.fieldId)return e.message;let t=`Answer ${e.fieldId} `,n=e.message.startsWith(t)?e.message.slice(t.length):e.message;return n.charAt(0).toUpperCase()+n.slice(1)}function Oe(e,t,n){let r=document.createElement("style");r.textContent=sl,e.appendChild(r);let o=document.createElement("div");o.className="bdv-root",o.dataset.presentation=n,t.presentation.kind==="modal"&&(o.dataset.size=t.presentation.size??"default"),o.dataset.density=t.appearance?.density??"comfortable",o.dataset.columns=String(t.presentation.columns??1);let i=_(t.appearance?.accentColor);i&&o.style.setProperty("--bdv-accent",i),e.appendChild(o);let a=t.appearance?.theme??"auto",s=c=>{o.classList.toggle("bdv-dark",c==="dark")};s(De(a));let l=a==="auto"?kt(s):()=>{};return{root:o,dispose(){l(),r.remove(),o.remove()}}}var sl=`
  :host {
    --bdv-accent: #2563eb;
    display: block;
    color-scheme: light;
...
`;function ao(e){if(!(e.target instanceof HTMLElement))throw new TypeError("BugDrop inline variant target must be an HTMLElement");if(e.config.presentation.kind!=="inline")throw new TypeError("BugDrop mount() requires an inline variant");ye(e.config.fields,e.options?.initialAnswers??{});let t=Q(e.config.id),n=document.createElement("div");n.dataset.bugdropOwned="",n.dataset.bugdropInstance=t;let r=n.attachShadow({mode:"open"}),o=de(n),i=Oe(r,e.config,"inline"),a=Nt({config:e.config,instanceId:t,context:e.options?.context,initialAnswers:e.options?.initialAnswers,submit:e.submit});i.root.appendChild(a.element),e.target.appendChild(n);let s=!1;return Object.freeze({instanceId:t,reset(){s||a.reset()},unmount(){s||(s=!0,a.dispose(),o(),i.dispose(),n.remove())}})}function lo(e){if(e.config.presentation.kind!=="modal")throw new TypeError("BugDrop open() requires a modal variant");ye(e.config.fields,e.options?.initialAnswers??{}),ze();let t=Q(e.config.id),n=document.activeElement instanceof HTMLElement?document.activeElement:null,r=document.body.style.getPropertyValue("overflow"),o=document.body.style.getPropertyPriority("overflow"),i=document.createElement("div");i.dataset.bugdropOwned="",i.dataset.bugdropInstance=t,Object.assign(i.style,{position:"fixed",inset:"0",zIndex:"2147483646"});let a=i.attachShadow({mode:"open"}),s=Oe(a,e.config,"modal"),l=document.createElement("div");l.className="bdv-overlay",s.root.appendChild(l);let c,d=new Promise(v=>{c=v}),u=!1,f=!1,m=()=>{},g=v=>{u||(u=!0,c(v))},h=()=>{f||(f=!0,g({status:"closed"}),m(),a.removeEventListener("keydown",F),l.removeEventListener("pointerdown",P),E.dispose(),L(),s.dispose(),i.remove(),ll(r,o),n?.isConnected&&n.focus())},E=Nt({config:e.config,instanceId:t,context:e.options?.context,initialAnswers:e.options?.initialAnswers,submit:e.submit,cancel:{label:e.config.content.cancelLabel??"Cancel",onCancel:h},onSubmitted:v=>g({status:"submitted",result:v})});E.element.setAttribute("role","dialog"),E.element.setAttribute("aria-modal","true"),E.element.dataset.size=e.config.presentation.size??"default";let C=document.createElement("button");C.type="button",C.className="bdv-close",C.setAttribute("aria-label","Close"),C.textContent="\xD7",C.addEventListener("click",h,{once:!0}),E.element.prepend(C),l.appendChild(E.element);function F(v){if(!(v instanceof KeyboardEvent))return;if(v.key==="Escape"){v.preventDefault(),h();return}if(v.key!=="Tab")return;let A=so(E.element);if(A.length===0){v.preventDefault(),E.element.focus();return}let z=a.activeElement,I=A[0],$=A.at(-1);v.shiftKey&&(z===I||!E.element.contains(z))?(v.preventDefault(),$.focus()):!v.shiftKey&&z===$&&(v.preventDefault(),I.focus())}function P(v){v.target===l&&h()}document.body.style.setProperty("overflow","hidden"),document.body.appendChild(i);let L=de(i);a.addEventListener("keydown",F),l.addEventListener("pointerdown",P);let D=Object.freeze({instanceId:t,result:d,close:h});return m=zt(D),queueMicrotask(()=>{if(f)return;(E.element.querySelector('textarea:not(:disabled), input:not(:disabled), [role="radio"][tabindex="0"]')??so(E.element)[0]??E.element).focus()}),D}function co(e){return Object.freeze({instanceId:Q(e),result:Promise.resolve({status:"busy"}),close(){}})}function so(e){return Array.from(e.querySelectorAll('button:not(:disabled), input:not(:disabled), textarea:not(:disabled), select:not(:disabled), a[href], [tabindex]:not([tabindex="-1"])')).filter(t=>!t.hidden&&t.getAttribute("aria-hidden")!=="true")}function ll(e,t){e?document.body.style.setProperty("overflow",e,t):document.body.style.removeProperty("overflow")}var _t=/^[a-z][a-z0-9_-]{0,63}$/,uo=/{{\s*([^{}]+?)\s*}}/g,cl=new Set(["bug","feature","question","feedback"]),dl=new Set(["shortText","longText","rating","singleChoice"]),ul=new Set(["id","configVersion","presentation","appearance","content","fields","issue"]),pl=new Set(["title","description","submitLabel","cancelLabel","successTitle","successMessage"]),ml=new Set(["theme","accentColor","density"]),bl=new Set(["classification","title","sections"]),Bt=["id","type","label","helpText","required","layout"],gl={shortText:new Set([...Bt,"placeholder","minLength","maxLength"]),longText:new Set([...Bt,"placeholder","rows","minLength","maxLength"]),rating:new Set([...Bt,"scale","icon","lowLabel","highLabel"]),singleChoice:new Set([...Bt,"options","display"])};function mo(e){if(!oe(e))throw new TypeError("BugDrop variant config must be an object");if(le(e,ul,"variant config"),typeof e.id!="string"||!_t.test(e.id)||e.id==="legacy")throw new TypeError("BugDrop variant id must match [a-z][a-z0-9_-]{0,63} and cannot be legacy");if(e.configVersion!==void 0&&e.configVersion!==1)throw new TypeError("BugDrop variant configVersion must be 1");if(fl(e.presentation),hl(e.appearance),yl(e.content),!Array.isArray(e.fields)||e.fields.length===0||e.fields.length>20)throw new TypeError("BugDrop variant fields must contain 1-20 entries");let t=new Map;for(let n of e.fields)wl(n,t);return Sl(e,t),bo(wn(e))}function fl(e){if(!oe(e)||e.kind!=="modal"&&e.kind!=="inline")throw new TypeError("BugDrop variant presentation must be modal or inline");if(le(e,e.kind==="modal"?new Set(["kind","size","columns"]):new Set(["kind","columns"]),"variant presentation"),e.columns!==void 0&&e.columns!==1&&e.columns!==2)throw new TypeError("BugDrop variant presentation columns must be 1 or 2");if(e.kind==="modal"&&e.size!==void 0&&!["compact","default","wide"].includes(e.size))throw new TypeError("BugDrop modal size must be compact, default, or wide")}function hl(e){if(e!==void 0){if(!oe(e))throw new TypeError("BugDrop variant appearance must be an object");if(le(e,ml,"variant appearance"),e.theme!==void 0&&!["light","dark","auto"].includes(e.theme))throw new TypeError("BugDrop variant appearance theme is invalid");if(e.accentColor!==void 0&&(!j(e.accentColor,120)||Tl(e.accentColor)))throw new TypeError("BugDrop variant appearance accentColor is invalid");if(e.density!==void 0&&e.density!=="compact"&&e.density!=="comfortable")throw new TypeError("BugDrop variant appearance density is invalid")}}function yl(e){if(!oe(e))throw new TypeError("BugDrop variant content must be an object");if(le(e,pl,"variant content"),!j(e.title,500))throw new TypeError("BugDrop variant content.title is required");et(e.description,"description",2e3),et(e.submitLabel,"submitLabel",120),et(e.cancelLabel,"cancelLabel",120),et(e.successTitle,"successTitle",500),et(e.successMessage,"successMessage",2e3)}function et(e,t,n){if(e!==void 0&&!j(e,n))throw new TypeError(`BugDrop variant content.${t} is invalid`)}function wl(e,t){if(!oe(e)||!dl.has(e.type)||typeof e.id!="string"||!_t.test(e.id))throw new TypeError("BugDrop variant field has an invalid type or id");if(le(e,gl[e.type],`field ${e.id}`),t.has(e.id))throw new TypeError(`Duplicate BugDrop variant field id: ${e.id}`);if(t.set(e.id,e),!j(e.label,500))throw new TypeError(`Field ${e.id} requires a label`);if(e.helpText!==void 0&&!j(e.helpText,1e3))throw new TypeError(`Field ${e.id} has invalid helpText`);if(e.required!==void 0&&typeof e.required!="boolean")throw new TypeError(`Field ${e.id} required must be boolean`);vl(e),e.type==="shortText"||e.type==="longText"?xl(e):e.type==="rating"?El(e):kl(e)}function vl(e){if(e.layout!==void 0){if(!oe(e.layout))throw new TypeError(`Field ${e.id} layout must be an object`);if(le(e.layout,new Set(["span"]),`field ${e.id} layout`),e.layout.span!==void 0&&e.layout.span!==1&&e.layout.span!==2)throw new TypeError(`Field ${e.id} layout span must be 1 or 2`)}}function xl(e){if(e.placeholder!==void 0&&!j(e.placeholder,500))throw new TypeError(`Field ${e.id} has invalid placeholder`);let t=e.type==="shortText"?500:5e3;if(e.minLength!==void 0&&!tt(e.minLength,0,5e3)||e.maxLength!==void 0&&!tt(e.maxLength,1,5e3))throw new TypeError(`Field ${e.id} has invalid text bounds`);let n=e.minLength===void 0?0:e.minLength,r=e.maxLength===void 0?t:e.maxLength;if(!tt(n,0,5e3)||!tt(r,1,5e3)||n>r)throw new TypeError(`Field ${e.id} has invalid text bounds`);if(e.type==="longText"&&e.rows!==void 0&&!tt(e.rows,1,50))throw new TypeError(`Field ${e.id} rows must be an integer from 1-50`)}function El(e){if(e.scale!==void 0&&e.scale!==5&&e.scale!==10)throw new TypeError(`Field ${e.id} rating scale must be 5 or 10`);if(e.icon!==void 0&&e.icon!=="star"&&e.icon!=="number")throw new TypeError(`Field ${e.id} rating icon must be star or number`);if(e.lowLabel!==void 0&&!j(e.lowLabel,500))throw new TypeError(`Field ${e.id} has invalid lowLabel`);if(e.highLabel!==void 0&&!j(e.highLabel,500))throw new TypeError(`Field ${e.id} has invalid highLabel`)}function kl(e){if(!Array.isArray(e.options)||e.options.length<2||e.options.length>50)throw new TypeError(`Field ${e.id} requires 2-50 choices`);if(e.display!==void 0&&e.display!=="radio"&&e.display!=="cards"&&e.display!=="buttons")throw new TypeError(`Field ${e.id} choice display is invalid`);let t=new Set;for(let n of e.options){if(!oe(n))throw new TypeError(`Field ${e.id} has an invalid choice`);if(le(n,new Set(["value","label","description"]),`field ${e.id} choice`),!j(n.value,120)||!j(n.label,500))throw new TypeError(`Field ${e.id} has an invalid choice`);if(n.description!==void 0&&!j(n.description,1e3))throw new TypeError(`Field ${e.id} has an invalid choice description`);if(t.has(n.value))throw new TypeError(`Field ${e.id} has duplicate choices`);t.add(n.value)}}function Sl(e,t){if(!oe(e.issue))throw new TypeError("BugDrop variant issue must be an object");if(le(e.issue,bl,"variant issue"),!j(e.issue.title,2e3))throw new TypeError("BugDrop variant issue.title is required");if(e.issue.classification!==void 0&&!cl.has(e.issue.classification))throw new TypeError("BugDrop variant issue.classification is invalid");for(let o of e.issue.title.matchAll(uo)){let i=o[1];if(i.startsWith("context.")){if(!_t.test(i.slice(8)))throw po()}else if(!t.has(i))throw new TypeError(`Unknown BugDrop variant title field: ${i}`)}if(e.issue.title.replace(uo,"").includes("{{"))throw po();if(e.issue.sections!==void 0&&!Array.isArray(e.issue.sections))throw new TypeError("BugDrop variant Issue accepts at most 20 sections");let n=e.issue.sections??[];if(n.length>20)throw new TypeError("BugDrop variant Issue accepts at most 20 sections");let r=new Set;for(let o of n)Cl(o,t,r)}function Cl(e,t,n){if(!oe(e)||!j(e.heading,120))throw new TypeError("BugDrop variant Issue section requires a heading");let r="field"in e,o="context"in e;if(r===o)throw new TypeError("BugDrop variant Issue section must reference one field or context key");if(le(e,r?new Set(["heading","field","format","omitWhenEmpty"]):new Set(["heading","context","format","omitWhenEmpty"]),"variant Issue section"),e.omitWhenEmpty!==void 0&&typeof e.omitWhenEmpty!="boolean")throw new TypeError("BugDrop variant Issue section omitWhenEmpty must be boolean");let i=e.heading.trim().toLowerCase();if(n.has(i))throw new TypeError(`Duplicate BugDrop Issue heading: ${e.heading}`);if(n.add(i),r){let a=t.get(e.field);if(!a)throw new TypeError(`Unknown Issue field: ${e.field}`);let s=e.format===void 0?"text":e.format;if(!["text","quote","stars","choice"].includes(s))throw new TypeError(`Invalid Issue field format: ${String(s)}`);if(s==="stars"&&a.type!=="rating")throw new TypeError("BugDrop stars format requires a rating field");if(s==="choice"&&a.type!=="singleChoice")throw new TypeError("BugDrop choice format requires a singleChoice field")}else{if(typeof e.context!="string"||!_t.test(e.context))throw new TypeError(`Invalid Issue context key: ${e.context}`);if(e.format!==void 0&&e.format!=="text"&&e.format!=="code")throw new TypeError(`Invalid Issue context format: ${String(e.format)}`)}}function po(){return new TypeError("BugDrop variant title contains an invalid placeholder")}function le(e,t,n){let r=Object.keys(e).find(o=>!t.has(o));if(r)throw new TypeError(`Unknown BugDrop ${n} property: ${r}`)}function j(e,t){return typeof e=="string"&&e.trim().length>0&&e.length<=t}function tt(e,t,n){return Number.isInteger(e)&&e>=t&&e<=n}function Tl(e){return Array.from(e).some(t=>{let n=t.charCodeAt(0);return n<32||n===127})}function oe(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function wn(e){return Array.isArray(e)?e.map(t=>wn(t)):oe(e)?Object.fromEntries(Object.entries(e).map(([t,n])=>[t,wn(n)])):e}function bo(e){if(e&&typeof e=="object"){Object.freeze(e);for(let t of Object.values(e))bo(t)}return e}function go(e,t,n={}){Al(n);let r=$e(e.fields,t),o=e.issue.title.replace(/{{\s*([^{}]+?)\s*}}/g,(a,s)=>{let l=s.startsWith("context.")?n[s.slice(8)]:r[s];return fo(e.fields,s,l,"text")}).replace(/\s+/g," ").trim().slice(0,256).trim();if(!o)throw new TypeError("BugDrop variant produced an empty Issue title");let i=(e.issue.sections??[]).flatMap(a=>{let s=Ll(a,e.fields,r,n);return!s.trim()&&a.omitWhenEmpty?[]:[{heading:a.heading.trim(),value:s.trim()?s:"Not provided.",format:Fl(a)}]});return{title:o,...e.issue.classification?{classification:e.issue.classification}:{},sections:i}}function Ll(e,t,n,r){return"context"in e?String(r[e.context]??""):fo(t,e.field,n[e.field],e.format??"text")}function fo(e,t,n,r){if(n==null||n==="")return"";let o=e.find(i=>i.id===t);if(r==="stars"&&o?.type==="rating"&&typeof n=="number"){let i=o.scale??5;return`${"\u2605".repeat(n)}${"\u2606".repeat(i-n)} (${n}/${i})`}return r==="choice"&&o?.type==="singleChoice"?o.options.find(i=>i.value===n)?.label??String(n):String(n)}function Fl(e){return e.format==="quote"||e.format==="code"?e.format:"text"}function Al(e){if(!Pl(e)||Object.keys(e).length>50)throw new TypeError("BugDrop variant context must contain at most 50 values");for(let[t,n]of Object.entries(e)){if(!/^[a-z][a-z0-9_-]{0,63}$/.test(t))throw new TypeError(`Invalid context key: ${t}`);if(!["string","number","boolean"].includes(typeof n)&&n!==null)throw new TypeError(`Invalid context value: ${t}`);if(typeof n=="number"&&!Number.isFinite(n))throw new TypeError(`Invalid context value: ${t}`);if(String(n??"").length>5e3)throw new TypeError(`Context value is too long: ${t}`)}}function Pl(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}async function ho(e,t,n,r={}){let o=r.submissionId??Rl(),i=go(t,n,r.context),a=await fetch(`${e.apiUrl}/feedback`,{method:"POST",headers:{"Content-Type":"application/json",...await he(e.authTokenProvider)},body:JSON.stringify({kind:"bugdrop.variant-submission",schemaVersion:1,repo:e.repo,variantId:t.id,submissionId:o,issue:i,metadata:Ml()})}),s=await a.json();if(!a.ok||s.success!==!0)throw new Error(typeof s.error=="string"?s.error:"Failed to submit feedback");if(!Number.isInteger(s.issueNumber)||s.issueNumber<=0||typeof s.issueUrl!="string"||!zl(s.issueUrl,e.repo,s.issueNumber)||typeof s.isPublic!="boolean")throw new Error("BugDrop received an invalid Issue result");return{issueNumber:s.issueNumber,issueUrl:s.issueUrl,isPublic:s.isPublic,...Array.isArray(s.labelMappingWarnings)&&s.labelMappingWarnings.every(l=>typeof l=="string")?{labelMappingWarnings:s.labelMappingWarnings}:{}}}function Rl(){if(typeof crypto?.randomUUID=="function")return crypto.randomUUID();if(typeof crypto?.getRandomValues!="function")throw new Error("BugDrop variants require a cryptographically secure random generator");let e=crypto.getRandomValues(new Uint8Array(16));return Array.from(e,t=>t.toString(16).padStart(2,"0")).join("")}function Ml(){let e=new URL(window.location.href);return e.search="",e.hash="",{url:e.toString(),userAgent:navigator.userAgent,viewport:{width:window.innerWidth,height:window.innerHeight},timestamp:new Date().toISOString(),browser:Dl(navigator.userAgent),os:Il(navigator.userAgent),devicePixelRatio:window.devicePixelRatio,language:navigator.language}}function Dl(e){for(let[t,n]of[["Edge",/Edg\/(\d+[\d.]*)/],["Chrome",/Chrome\/(\d+[\d.]*)/],["Safari",/Version\/(\d+[\d.]*).*Safari/],["Firefox",/Firefox\/(\d+[\d.]*)/]]){let r=e.match(n);if(r)return{name:t,version:r[1]??"unknown"}}return{name:"Unknown",version:"unknown"}}function Il(e){let t=e.match(/(?:Mac OS X|Windows NT|Android) ([\d_.]+)/);return t?{name:e.includes("Mac OS X")?"macOS":e.includes("Windows NT")?"Windows":"Android",version:(t[1]??"unknown").replaceAll("_",".")}:{name:e.includes("Linux")?"Linux":"Unknown",version:"unknown"}}function zl(e,t,n){try{let r=new URL(e);return r.protocol==="https:"&&r.hostname==="github.com"&&r.pathname.toLowerCase()===`/${t}/issues/${n}`.toLowerCase()&&!r.search&&!r.hash}catch{return!1}}function yo(e,t={isLegacyModalOpen:()=>!1}){let n=new Map;return{register(r){let o=mo(r);if(n.has(o.id))throw new TypeError(`BugDrop variant is already registered: ${o.id}`);let i=to(o);n.set(o.id,i);let s=i.screens[0].config,l=(c,d={})=>ho(e,s,c,d);return Object.freeze({id:i.variantId,open(c){if(s.presentation.kind!=="modal")throw new TypeError("BugDrop open() requires a modal variant");return t.isLegacyModalOpen()?co(i.variantId):lo({config:s,options:c,submit:l})},mount(c,d){return ao({config:s,target:c,options:d,submit:l})},submit(c,d={}){return l(c,d)}})}}}function nt(e,t,n){return e?"answer"in e?wo(t,e.answer,e.equals):"context"in e?wo(n,e.context,e.equals):"all"in e?e.all.every(r=>nt(r,t,n)):e.any.some(r=>nt(r,t,n)):!0}function wo(e,t,n){return Object.prototype.hasOwnProperty.call(e,t)&&e[t]===n}function vn(e,t=1){if(t>4)throw new TypeError("BugDrop flow condition depth cannot exceed 4");if("answer"in e||"context"in e)return 1;let n="all"in e?e.all:e.any,r=1;for(let o of n)r+=vn(o,t+1);if(r>32)throw new TypeError("BugDrop flow conditions cannot exceed 32 nodes");return r}var Ne=class{constructor(t,n,r={}){this.definition=t;this.context=n;this.answers={...r},this.reconcileInitiallyHidden(),this.currentId=this.visibleScreens()[0]?.id??""}definition;context;answers;capture=null;currentId;current(){return this.route().screen}route(){let t=this.visibleScreens(),n=t.findIndex(o=>o.id===this.currentId),r=n>=0?n:0;return Object.freeze({screen:t[r],position:t.length===0?0:r+1,total:t.length,canGoBack:r>0,hasNext:r>=0&&r<t.length-1})}setFormAnswers(t,n){let r=new Set(this.visibleScreens().map(i=>i.id)),o=this.definition.screenAnswerPaths.get(this.definition.screens.find(i=>i.type==="form"&&i.form===t).id);for(let i of o){let a=i.slice(t.length+1);this.answers[i]=n[a]}this.reconcileNewlyHidden(r)}next(){let t=this.route(),n=this.visibleScreens();return t.hasNext?(this.currentId=n[t.position].id,!0):!1}back(){let t=this.route(),n=this.visibleScreens();return t.canGoBack?(this.currentId=n[t.position-2].id,!0):!1}hasNext(){return this.route().hasNext}visibleScreens(){return this.definition.screens.filter(t=>nt(t.when,this.answers,this.context))}reconcileInitiallyHidden(){for(let t of this.definition.screens)nt(t.when,this.answers,this.context)||this.clearScreenState(t)}reconcileNewlyHidden(t){let n=new Set(this.visibleScreens().map(o=>o.id)),r=!0;for(;r;){r=!1;for(let o of this.definition.screens)!t.has(o.id)||n.has(o.id)||(r=this.clearScreenState(o)||r);r&&(n=new Set(this.visibleScreens().map(o=>o.id)))}n.has(this.currentId)||(this.currentId=this.nearestVisibleId(n))}clearScreenState(t){let n=!1;for(let r of this.definition.screenAnswerPaths.get(t.id)??[])Object.prototype.hasOwnProperty.call(this.answers,r)&&(n=!0),delete this.answers[r];return t.type==="screenshot"&&this.capture!==null&&(this.capture=null,n=!0),n}nearestVisibleId(t){let n=this.definition.screens.findIndex(r=>r.id===this.currentId);for(let r=n;r>=0;r-=1){let o=this.definition.screens[r];if(o&&t.has(o.id))return o.id}return this.visibleScreens()[0]?.id??""}};async function vo(e,t){let n=await t.preflight(e.system.preflight);if(n.status!=="installed")return t.showPreflightFailure(n),"preflight-blocked";let r=e.steps[0],o=new Ne(e.flow,{"show-welcome":r.enabled});if(o.current()?.id==="welcome"){if(!await t.showWelcome(r))return"finished";r.remember&&t.rememberWelcome(r),o.next()}let i=e.steps[1],a=e.steps[2],s=null;for(;;){if(o.current()?.id!=="details")throw new Error("Default flow expected details screen");if(s=await t.showDetails(i,s),!s)return"finished";if(o.next(),o.current()?.id!=="screenshot")throw new Error("Default flow expected screenshot screen");let l=await t.capture(a,s);if(l.returnToDetails){o.back();continue}return await t.submit(e.system.submission,s,l),"finished"}}function Ht(e){let t=new Map;for(let o of e.forms)for(let i of o.fields)t.set(`${o.id}.${i.id}`,i);let n=new Map,r=new Set;for(let o of e.screens)xn(o.when,r),n.set(o.id,o.type==="form"?e.forms.find(i=>i.id===o.form).fields.map(i=>`${o.form}.${i.id}`):[]);for(let o of e.issue.sections??[])"context"in o&&r.add(o.context);return Object.freeze({compiler:"bugdrop-flow@1",flowId:e.id,config:e,fields:t,contextKeys:r,screenAnswerPaths:n,screens:e.screens})}function xn(e,t){e&&("context"in e?t.add(e.context):"all"in e?e.all.forEach(n=>xn(n,t)):"any"in e&&e.any.forEach(n=>xn(n,t)))}var $l=new Set(["image/png","image/jpeg","image/gif","image/webp","application/pdf","video/mp4","video/webm","video/quicktime"]);function Ut(e){return $l.has(e)}function qt(e,t){let n=t;return t!==void 0&&!ce(t)&&k("open options must be an object"),we(t??{},new Set(["context","initialAnswers"]),"open options"),{context:Object.freeze(Nl(e,n?.context)),initialAnswers:Bl(e,n?.initialAnswers)}}function xo(e){_l(e),e.type==="shortText"||e.type==="longText"?Hl(e):e.type==="rating"?Vl(e):e.type==="singleChoice"?Ul(e):e.type==="checkbox"?ql(e):Wl(e)}function Eo(e,t){if(e.type==="rating"){let o=e.scale??5;(!Number.isInteger(t)||t<1||t>o)&&k(`condition equals is not a valid value for field ${e.id}`);return}if(e.type==="singleChoice"){(typeof t!="string"||!e.options.some(o=>o.value===t))&&k(`condition equals is not a valid value for field ${e.id}`);return}if(e.type==="checkbox"){typeof t!="boolean"&&k(`condition equals is not a valid value for field ${e.id}`);return}e.type==="attachments"&&k(`condition answer cannot reference attachments field ${e.id}`),(typeof t!="string"||t!==t.trim())&&k(`condition equals is not a valid value for field ${e.id}`);let n=e.minLength??0,r=e.maxLength??(e.type==="shortText"?500:5e3);(t.length<n||t.length>r)&&k(`condition equals is not a valid value for field ${e.id}`)}function ko(e){let{presentation:t,appearance:n,content:r}=e;ce(t)||k("presentation must be an object"),we(t,new Set(["kind","size","columns"]),"presentation"),t.kind!=="modal"&&k("presentation kind must be modal"),t.size!==void 0&&!["compact","default","wide"].includes(t.size)&&k("modal size is invalid"),t.columns!==void 0&&t.columns!==1&&t.columns!==2&&k("presentation columns must be 1 or 2"),n!==void 0&&(ce(n)||k("appearance must be an object"),we(n,new Set(["theme","accentColor","density"]),"appearance"),n.theme!==void 0&&!["light","dark","auto"].includes(n.theme)&&k("appearance theme is invalid"),me(n.accentColor,"appearance accentColor",120),n.density!==void 0&&!["compact","comfortable"].includes(n.density)&&k("appearance density is invalid")),r!==void 0&&(ce(r)||k("content must be an object"),we(r,new Set(["successTitle","successMessage","cancelLabel"]),"content"),me(r.successTitle,"successTitle",500),me(r.successMessage,"successMessage",2e3),me(r.cancelLabel,"cancelLabel",120))}function Ol(e,t){if(e.type==="shortText"||e.type==="longText"){typeof t!="string"&&k(`initial answer ${e.id} must be text`);let n=e.minLength??0,r=e.maxLength??(e.type==="shortText"?500:5e3),o=t.trim();return(o.length<n||o.length>r)&&k(`initial answer ${e.id} has invalid length`),o}if(e.type==="rating"){let n=e.scale??5;return(!Number.isInteger(t)||t<1||t>n)&&k(`initial answer ${e.id} must be a rating from 1-${n}`),t}return e.type==="singleChoice"?((typeof t!="string"||!e.options.some(n=>n.value===t))&&k(`initial answer ${e.id} must be a configured choice`),t):e.type==="checkbox"?(typeof t!="boolean"&&k(`initial answer ${e.id} must be boolean`),t):jl(e,t)}function Nl(e,t){t!==void 0&&!ce(t)&&k("context must be an object");let n=t??{},r=Object.keys(n).find(i=>!e.contextKeys.has(i));r&&k(`context contains unknown key ${r}`);let o={};for(let[i,a]of Object.entries(n))(!Kl(a)||typeof a=="number"&&!Number.isFinite(a))&&k(`context ${i} must be a finite scalar`),o[i]=a;return o}function Bl(e,t){t!==void 0&&!ce(t)&&k("initialAnswers must be an object");let n=t??{},r=Object.keys(n).find(o=>!e.fields.has(o));return r&&k(`initialAnswers contains unknown key ${r}`),Object.fromEntries(Object.entries(n).map(([o,i])=>[o,Ol(e.fields.get(o),i)]))}function _l(e){e.layout!==void 0&&(ce(e.layout)||k(`field ${e.id} layout must be an object`),we(e.layout,new Set(["span"]),`field ${e.id} layout`),e.layout.span!==void 0&&e.layout.span!==1&&e.layout.span!==2&&k(`field ${e.id} layout span must be 1 or 2`))}function Hl(e){me(e.placeholder,`field ${e.id} placeholder`,500);let t=e.minLength??0,n=e.maxLength??(e.type==="shortText"?500:5e3);(!Be(t,0,5e3)||!Be(n,1,5e3)||t>n)&&k(`field ${e.id} has invalid text bounds`),e.type==="longText"&&e.rows!==void 0&&!Be(e.rows,1,50)&&k(`field ${e.id} rows must be 1-50`)}function Vl(e){e.scale!==void 0&&e.scale!==5&&e.scale!==10&&k(`field ${e.id} rating scale must be 5 or 10`),e.icon!==void 0&&e.icon!=="star"&&e.icon!=="number"&&k(`field ${e.id} rating icon is invalid`),me(e.lowLabel,`field ${e.id} lowLabel`,500),me(e.highLabel,`field ${e.id} highLabel`,500)}function Ul(e){(!Array.isArray(e.options)||e.options.length<2||e.options.length>50)&&k(`field ${e.id} requires 2-50 choices`),e.display!==void 0&&!["radio","cards","buttons"].includes(e.display)&&k(`field ${e.id} choice display is invalid`);let t=new Set;for(let n of e.options)ce(n)||k(`field ${e.id} has an invalid choice`),we(n,new Set(["value","label","description"]),`field ${e.id} choice`),Vt(n.value,`field ${e.id} choice value`,120),Vt(n.label,`field ${e.id} choice label`,500),me(n.description,`field ${e.id} choice description`,1e3),t.has(n.value)&&k(`field ${e.id} has duplicate choices`),t.add(n.value)}function ql(e){e.initialValue!==void 0&&typeof e.initialValue!="boolean"&&k(`field ${e.id} initialValue must be boolean`)}function Wl(e){e.maxFiles!==void 0&&!Be(e.maxFiles,1,5)&&k(`field ${e.id} maxFiles must be 1-5`),e.maxFileSize!==void 0&&!Be(e.maxFileSize,1,5*1024*1024)&&k(`field ${e.id} maxFileSize is invalid`),e.accept!==void 0&&(!Array.isArray(e.accept)||e.accept.length===0||e.accept.length>20||e.accept.some(t=>typeof t!="string"||!t.trim()||t.length>120||!Ut(t)))&&k(`field ${e.id} accept is invalid`)}function jl(e,t){return(!Array.isArray(t)||t.length>(e.maxFiles??5))&&k(`initial answer ${e.id} has too many attachments`),t.map(n=>{ce(n)||k(`initial answer ${e.id} has an invalid attachment`),we(n,new Set(["name","type","size","dataUrl"]),"attachment"),Vt(n.name,"attachment name",500),(typeof n.type!="string"||!Ut(n.type))&&k("attachment type is invalid"),e.accept&&!e.accept.includes(n.type)&&k(`initial answer ${e.id} has a disallowed attachment type`),Be(n.size,0,e.maxFileSize??5*1024*1024)||k("attachment size is invalid"),(typeof n.dataUrl!="string"||!new RegExp(`^data:${Gl(n.type)};base64,[A-Za-z0-9+/]+={0,2}$`).test(n.dataUrl))&&k("attachment dataUrl is invalid");let r=n.dataUrl.slice(n.dataUrl.indexOf(",")+1);return r.length%4!==0&&k("attachment dataUrl is invalid"),atob(r).length>(e.maxFileSize??5*1024*1024)&&k("attachment size is invalid"),{name:n.name,type:n.type,size:n.size,dataUrl:n.dataUrl}})}function Gl(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Vt(e,t,n){(typeof e!="string"||!e.trim()||e.length>n||Xl(e))&&k(`${t} is invalid`)}function me(e,t,n){e!==void 0&&Vt(e,t,n)}function Xl(e){return[...e].some(t=>{let n=t.charCodeAt(0);return n<32&&n!==9&&n!==10&&n!==13||n===127})}function Be(e,t,n){return Number.isInteger(e)&&e>=t&&e<=n}function Kl(e){return e===null||["string","number","boolean"].includes(typeof e)}function ce(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function we(e,t,n){let r=Object.keys(e).find(o=>!t.has(o));r&&k(`${n} contains unknown key ${r}`)}function k(e){throw new TypeError(`BugDrop flow ${e}`)}var Yl=/^[a-z][a-z0-9_-]{0,63}$/;function G(e,t,n){for(let r of Object.keys(e))t.has(r)||S(`${n} contains unknown key ${r}`)}function ve(e,t){(typeof e!="string"||!Yl.test(e)||e==="legacy")&&S(`${t} is invalid`)}function xe(e,t,n){(typeof e!="string"||e.trim().length===0||e.length>n||[...e].some(r=>{let o=r.charCodeAt(0);return o<32&&o!==9&&o!==10&&o!==13}))&&S(`${t} is invalid`)}function be(e,t,n){e!==void 0&&xe(e,t,n)}function En(e,t){(e!==null&&!["string","number","boolean"].includes(typeof e)||typeof e=="number"&&!Number.isFinite(e))&&S(`${t} must be scalar`)}function ie(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function S(e){throw new TypeError(`BugDrop flow ${e}`)}function kn(e){if(!e||typeof e!="object"||Object.isFrozen(e))return e;Object.freeze(e);for(let t of Object.values(e))kn(t);return e}var Lo=/^([a-z][a-z0-9_-]{0,63})\.([a-z][a-z0-9_-]{0,63})$/,Zl=new Set(["configVersion","id","presentation","appearance","content","forms","screens","issue","evidence"]),_e=["id","type","label","helpText","required","layout"],So={shortText:new Set([..._e,"placeholder","minLength","maxLength"]),longText:new Set([..._e,"placeholder","rows","minLength","maxLength"]),rating:new Set([..._e,"scale","icon","lowLabel","highLabel"]),singleChoice:new Set([..._e,"options","display"]),checkbox:new Set([..._e,"initialValue"]),attachments:new Set([..._e,"maxFiles","maxFileSize","accept"])};function Wt(e){ie(e)||S("config must be an object"),G(e,Zl,"config"),e.configVersion!==1&&S("configVersion must be 1"),ve(e.id,"id"),ko(e),(!Array.isArray(e.forms)||e.forms.length===0||e.forms.length>12)&&S("forms must contain 1-12 entries"),(!Array.isArray(e.screens)||e.screens.length===0||e.screens.length>20)&&S("screens must contain 1-20 entries");let t=new Map,n=new Map;for(let l of e.forms)Jl(l,n,t);let r=new Set,o=new Set,i=new Map,a=0,s=new Set;for(let l of e.screens){if(Ql(l,s,n,i),l.type==="form"){r.has(l.form)&&S(`form ${l.form} may be referenced only once`),r.add(l.form);for(let c of n.get(l.form).fields)i.set(`${l.form}.${c.id}`,c);if(l.when===void 0)for(let c of n.get(l.form).fields)c.required&&o.add(`${l.form}.${c.id}`)}l.type==="screenshot"&&++a>1&&S("only one screenshot screen is supported")}for(let l of n.keys())r.has(l)||S(`form ${l} is unused`);return e.screens.every(l=>l.when!==void 0)&&S("at least one screen must be unconditional"),ec(e.issue,t,o),nc(e.evidence,t),kn(structuredClone(e))}function Jl(e,t,n){ie(e)||S("form must be an object"),G(e,new Set(["id","title","description","fields"]),"form"),ve(e.id,"form id"),t.has(e.id)&&S(`duplicate form id ${e.id}`),xe(e.title,"form title",500),be(e.description,"form description",2e3),(!Array.isArray(e.fields)||e.fields.length===0||e.fields.length>20)&&S("form fields must contain 1-20 entries");let r=new Set;for(let o of e.fields)(!ie(o)||typeof o.type!="string"||!(o.type in So))&&S("field type is unsupported"),G(o,So[o.type],"field"),ve(o.id,"field id"),r.has(o.id)&&S(`duplicate field id ${o.id}`),r.add(o.id),xe(o.label,"field label",500),be(o.helpText,"field helpText",1e3),o.required!==void 0&&typeof o.required!="boolean"&&S("field required must be boolean"),xo(o),n.set(`${e.id}.${o.id}`,o);t.set(e.id,e)}function Ql(e,t,n,r){ie(e)||S("screen must be an object"),ve(e.id,"screen id"),t.has(e.id)&&S(`duplicate screen id ${e.id}`),t.add(e.id),["message","form","screenshot"].includes(e.type)||S("screen type is unsupported");let o=e.type==="message"?new Set(["id","type","when","title","description","continueLabel"]):e.type==="form"?new Set(["id","type","when","form","continueLabel","backLabel"]):new Set(["id","type","when","title","description","mode","continueLabel","backLabel"]);G(e,o,"screen"),Object.prototype.hasOwnProperty.call(e,"when")&&Fo(e.when,r),e.type==="message"&&(xe(e.title,"message title",500),be(e.description,"message description",2e3)),e.type==="form"&&!n.has(e.form)&&S(`screen references unknown form ${e.form}`),e.type==="screenshot"&&!["optional","auto","required"].includes(e.mode)&&S("screenshot mode is invalid"),e.type==="screenshot"&&(be(e.title,"screenshot title",500),be(e.description,"screenshot description",2e3)),be(e.continueLabel,"screen continueLabel",120),e.type!=="message"&&be(e.backLabel,"screen backLabel",120)}function Fo(e,t){if(ie(e)||S("condition must be an object"),vn(e),"answer"in e){G(e,new Set(["answer","equals"]),"answer condition");let o=t.get(e.answer);o||S(`condition answer must reference an earlier field: ${e.answer}`),En(e.equals,"condition equals"),Eo(o,e.equals);return}if("context"in e){G(e,new Set(["context","equals"]),"context condition"),ve(e.context,"condition context"),En(e.equals,"condition equals");return}let n="all"in e?"all":"any"in e?"any":null;n||S("condition must contain answer, context, all, or any"),G(e,new Set([n]),"condition group");let r=n==="all"?e.all:e.any;(!Array.isArray(r)||r.length<1||r.length>8)&&S(`condition ${n} must contain 1-8 entries`);for(let o of r)Fo(o,t)}function ec(e,t,n){if(ie(e)||S("issue must be an object"),G(e,new Set(["classification","title","sections"]),"issue"),xe(e.title,"issue title",2e3),e.classification!==void 0&&!["bug","feature","question"].includes(e.classification)&&S("issue classification is invalid"),rc(e.title,t,n),e.sections!==void 0){(!Array.isArray(e.sections)||e.sections.length>20)&&S("issue sections are invalid");let r=new Set;for(let o of e.sections)tc(o,t,r)}}function tc(e,t,n){ie(e)||S("issue section must be an object"),"answer"in e?(G(e,new Set(["heading","answer","format","omitWhenEmpty"]),"issue section"),Ao(e.answer,t,"issue section")):(G(e,new Set(["heading","context","format","omitWhenEmpty"]),"issue section"),ve(e.context,"issue context")),xe(e.heading,"issue section heading",120);let r=e.heading.trim().toLowerCase();n.has(r)&&S(`duplicate issue section heading ${e.heading}`),n.add(r),e.omitWhenEmpty!==void 0&&typeof e.omitWhenEmpty!="boolean"&&S("issue section omitWhenEmpty must be boolean");let o=e.format??"text";if("answer"in e){["text","quote","stars","choice","code"].includes(o)||S("issue answer format is invalid");let i=t.get(e.answer);o==="stars"&&i.type!=="rating"&&S("stars format requires a rating field"),o==="choice"&&i.type!=="singleChoice"&&S("choice format requires a singleChoice field")}else["text","code"].includes(o)||S("issue context format is invalid")}function nc(e,t){e!==void 0&&(ie(e)||S("evidence must be an object"),G(e,new Set(["attachments","sendConsoleLogs","submitter"]),"evidence"),Co(e.attachments,"attachments",t,"attachments"),Co(e.sendConsoleLogs,"checkbox",t,"sendConsoleLogs"),e.submitter!==void 0&&(ie(e.submitter)||S("evidence submitter must be an object"),G(e.submitter,new Set(["name","email"]),"evidence submitter"),!e.submitter.name&&!e.submitter.email&&S("evidence submitter must map name or email"),e.submitter.name&&To(e.submitter.name,t,"submitter name"),e.submitter.email&&To(e.submitter.email,t,"submitter email")))}function Co(e,t,n,r){e!==void 0&&n.get(e)?.type!==t&&S(`${r} must reference a ${t} field`)}function Ao(e,t,n){(!Lo.test(e)||!t.has(e)||t.get(e)?.type==="attachments")&&S(`${n} references an unknown scalar answer: ${e}`)}function To(e,t,n){let r=t.get(e)?.type;(!Lo.test(e)||r!=="shortText"&&r!=="longText")&&S(`${n} must reference a text field`)}function rc(e,t,n){let r=0,o=!1,i="";for(let s of e.matchAll(/{{\s*([^{}]+?)\s*}}/g)){let l=s.index,c=e.slice(r,l);i+=c,(c.includes("{{")||c.includes("}}")||c.endsWith("{"))&&S("issue title template is malformed");let d=s[1].trim();Ao(d,t,"issue title"),o||=n.has(d),r=l+s[0].length,e[r]==="}"&&S("issue title template is malformed")}let a=e.slice(r);(a.includes("{{")||a.includes("}}"))&&S("issue title template is malformed"),i+=a,!i.trim()&&!o&&S("issue title must contain text or reference a required answer")}var oc="bugdrop-default@1";function ic(e){if(e)return Object.freeze(Object.fromEntries(Object.entries(e).map(([t,n])=>[t,Array.isArray(n)?Object.freeze([...n]):n])))}function Po(e){let t=!e.skipWelcome&&e.welcome!=="never"&&!(e.welcome==="once"&&e.hasSeenWelcome),n=Object.freeze([Object.freeze({kind:"welcome",enabled:t,remember:t&&e.welcome==="once"}),Object.freeze({kind:"details",repo:e.repo,showName:e.showName,requireName:e.requireName,showEmail:e.showEmail,requireEmail:e.requireEmail,sendConsoleLogs:e.sendConsoleLogs}),Object.freeze({kind:"screenshot",mode:e.screenshotMode,repo:e.repo,screenshotScale:e.screenshotScale,elementContextMaxArea:e.elementContextMaxArea,accentColor:e.accentColor})]),r={configVersion:1,id:"bugdrop-default-v1",presentation:{kind:"modal"},forms:[{id:"details",title:"Send Feedback",fields:[{id:"title",type:"shortText",label:"Title",required:!0},{id:"description",type:"longText",label:"Description"},{id:"category",type:"singleChoice",label:"Category",required:!0,options:[{value:"bug",label:"Bug"},{value:"feature",label:"Feature"},{value:"question",label:"Question"}]},{id:"attachments",type:"attachments",label:"Attachments"},{id:"send-console-logs",type:"checkbox",label:"Include console logs"},{id:"name",type:"shortText",label:"Name"},{id:"email",type:"shortText",label:"Email"}]}],screens:[{id:"welcome",type:"message",title:"Share feedback",when:{context:"show-welcome",equals:!0}},{id:"details",type:"form",form:"details"},{id:"screenshot",type:"screenshot",mode:e.screenshotMode}],issue:{classification:"bug",title:"{{details.title}}",sections:[{heading:"Description",answer:"details.description",omitWhenEmpty:!0}]},evidence:{attachments:"details.attachments",sendConsoleLogs:"details.send-console-logs",submitter:{name:"details.name",email:"details.email"}}},o=Ht(Wt(r));return Object.freeze({id:oc,flow:o,steps:n,system:Object.freeze({preflight:Object.freeze({kind:"installation",repo:e.repo,apiUrl:e.apiUrl,authTokenProvider:e.authTokenProvider}),submission:Object.freeze({kind:"legacy-feedback",repo:e.repo,apiUrl:e.apiUrl,authTokenProvider:e.authTokenProvider,categoryLabels:ic(e.categoryLabels),issueLinkVisibility:e.issueLinkVisibility})})})}function Ro(e){return Object.freeze({instanceId:Q(e),result:Promise.resolve({status:"busy"}),close(){}})}function Do(e,t,n,r){let o=zo(e,n),i=document.createElement("input");return i.type="checkbox",i.id=o.controlId,i.checked=typeof r[`${t}.${e.id}`]=="boolean"?!!r[`${t}.${e.id}`]:!!e.initialValue,i.setAttribute("aria-required",String(e.required??!1)),o.describedBy&&i.setAttribute("aria-describedby",o.describedBy),o.wrapper.classList.add("bdf-checkbox"),o.wrapper.insertBefore(i,o.label),{id:e.id,required:!!e.required,element:o.wrapper,read:async()=>({ok:!0,value:i.checked}),setRequiredError(a){o.setError(i,a?"This checkbox is required.":null)},focus:()=>i.focus(),dispose(){}}}function Io(e,t,n,r){let o=zo(e,n);o.wrapper.classList.add("bdf-attachment");let i=document.createElement("input");i.className="bdv-input",i.type="file",i.id=o.controlId,i.multiple=(e.maxFiles??5)>1,i.setAttribute("aria-required",String(e.required??!1)),e.accept&&(i.accept=e.accept.join(",")),o.describedBy&&i.setAttribute("aria-describedby",o.describedBy);let a=document.createElement("ul");a.className="bdf-file-list",a.setAttribute("aria-live","polite"),o.wrapper.insertBefore(i,o.error),o.wrapper.insertBefore(a,o.error);let s=r[`${t}.${e.id}`],l=Array.isArray(s)?[...s]:[],c=!1,d=Promise.resolve(),u=0;Mo(a,l.map(m=>m.name));let f=()=>{let m=++u;c=!1,o.setError(i,null);let g=Array.from(i.files??[]);d=ac(g,e).then(h=>{m===u&&(l=h,Mo(a,h.map(E=>E.name)))}).catch(h=>{m===u&&(c=!0,o.setError(i,h instanceof Error?h.message:"Could not read the selected attachment."))})};return i.addEventListener("change",f),{id:e.id,required:!!e.required,element:o.wrapper,async read(m){for(;;){let g=d;if(await g,g===d)break}return c&&m?{ok:!1}:{ok:!0,value:l}},setRequiredError(m){c||o.setError(i,m?"Select at least one attachment.":null)},focus:()=>i.focus(),dispose:()=>{u+=1,i.removeEventListener("change",f)}}}function zo(e,t){let n=document.createElement("div");n.className="bdv-field",n.dataset.bugdropField=e.id,n.dataset.span=String(e.layout?.span??1);let r=`${t}-${e.id}`,o=document.createElement("label");if(o.className="bdv-label",o.htmlFor=r,o.textContent=e.label,e.required){let s=document.createElement("span");s.className="bdv-required",s.textContent=" *",s.setAttribute("aria-hidden","true"),o.appendChild(s)}n.appendChild(o);let i=[];if(e.helpText){let s=document.createElement("div");s.className="bdv-help",s.id=`${r}-help`,s.textContent=e.helpText,n.appendChild(s),i.push(s.id)}let a=document.createElement("div");return a.className="bdv-error",a.id=`${r}-error`,a.hidden=!0,a.setAttribute("aria-live","polite"),n.appendChild(a),i.push(a.id),{wrapper:n,label:o,error:a,controlId:r,describedBy:i.join(" ")||null,setError(s,l){a.textContent=l??"",a.hidden=!l,l?s.setAttribute("aria-invalid","true"):s.removeAttribute("aria-invalid")}}}async function ac(e,t){if(e.length>(t.maxFiles??5))throw new TypeError(`Select at most ${t.maxFiles??5} attachments.`);return Promise.all(e.map(n=>sc(n,t.maxFileSize??5*1024*1024,t.accept)))}async function sc(e,t,n){if(!Ut(e.type))throw new TypeError(`${e.name} has an unsupported file type.`);if(n&&!n.includes(e.type))throw new TypeError(`${e.name} is not an accepted file type.`);if(e.size>t)throw new TypeError(`${e.name} is too large.`);let r=await new Promise((o,i)=>{let a=new FileReader;a.addEventListener("load",()=>typeof a.result=="string"?o(a.result):i(new Error("Could not read the selected attachment."))),a.addEventListener("error",()=>i(new Error("Could not read the selected attachment."))),a.readAsDataURL(e)});return{name:e.name,type:e.type,size:e.size,dataUrl:r}}function Mo(e,t){e.replaceChildren(...t.map(n=>{let r=document.createElement("li");return r.textContent=n,r}))}function $o(e,t,n){let r=cc(e),o=document.createElement("div");o.className="bdv-fields",r.appendChild(o);let i=e.fields.map(s=>lc(s,e.id,t,n));for(let s of i)o.appendChild(s.element);let a=async s=>{let l=i.filter(pc);for(let d of l)d.setError(null);let c=Object.fromEntries(l.map(d=>[d.field.id,d.getValue()]));if(s)try{c=$e(e.fields.filter(uc),c)}catch(d){return dc(d,l),null}for(let d of i.filter(mc)){d.setRequiredError(!1);let u=await d.read(s);if(!u.ok)return d.focus(),null;if(s&&d.required&&(u.value===!1||Array.isArray(u.value)&&u.value.length===0))return d.setRequiredError(!0),d.focus(),null;c[d.id]=u.value}return c};return{element:r,collect:()=>a(!0),snapshot:()=>a(!1),dispose(){for(let s of i)s.dispose()}}}function lc(e,t,n,r){if(e.type==="checkbox")return Do(e,t,n,r);if(e.type==="attachments")return Io(e,t,n,r);let o=Ot(e,n);return o.setValue(r[`${t}.${e.id}`]??""),o}function cc(e){let t=document.createElement("section");t.className="bdv-surface";let n=document.createElement("div");n.className="bdv-header";let r=document.createElement("h2");if(r.className="bdv-title",r.textContent=e.title,n.appendChild(r),e.description){let o=document.createElement("p");o.className="bdv-description",o.textContent=e.description,n.appendChild(o)}return t.appendChild(n),t}function dc(e,t){let n=e instanceof se?t.find(r=>r.field.id===e.fieldId):void 0;n?.setError(e instanceof Error?e.message.replace(/^Answer \S+ /,""):"Invalid answer"),n?.focus()}function uc(e){return e.type!=="checkbox"&&e.type!=="attachments"}function pc(e){return"field"in e}function mc(e){return"read"in e}function Oo(e){let t=document.createElement("section");t.className="bdv-surface bdf-message";let n=document.createElement("div");n.className="bdv-header";let r=document.createElement("h2");if(r.className="bdv-title",r.textContent=e.title,n.appendChild(r),e.description){let o=document.createElement("p");o.className="bdv-description",o.textContent=e.description,n.appendChild(o)}return t.appendChild(n),t}function No(e,t,n,r,o){let i=document.activeElement instanceof HTMLElement?document.activeElement:null,a=document.body.style.getPropertyValue("overflow"),s=document.body.style.getPropertyPriority("overflow"),l=document.createElement("div");l.dataset.bugdropOwned="",l.dataset.bugdropFlow=e,l.dataset.bugdropInstance=t,Object.assign(l.style,{position:"fixed",inset:"0",zIndex:"2147483646"});let c=l.attachShadow({mode:"open"}),d=n(c),u=document.createElement("div");u.className="bdv-overlay",d.root.appendChild(u);let f=()=>{},m=()=>{},g=!1;return{host:l,shadow:c,overlay:u,activate(h){document.body.style.setProperty("overflow","hidden"),document.body.appendChild(l),m=de(l),c.addEventListener("keydown",r),u.addEventListener("pointerdown",o),f=zt({close:h})},dispose(){g||(g=!0,f(),c.removeEventListener("keydown",r),u.removeEventListener("pointerdown",o),m(),d.dispose(),l.remove(),a?document.body.style.setProperty("overflow",a,s):document.body.style.removeProperty("overflow"),i?.isConnected&&i.focus())}}}function Sn(e,t,n){let r=e.querySelector(".bdv-title"),o=`${t}-title`;return r&&(r.id=o),e.setAttribute("role","dialog"),e.setAttribute("aria-modal","true"),e.setAttribute("aria-labelledby",o),e.tabIndex=-1,e.dataset.size=n,e}function Bo(e,t,n,r,o){let i=t.screen,a=He("\xD7","bdv-close");a.setAttribute("aria-label","Close"),a.addEventListener("click",o,{once:!0}),e.prepend(a);let s=document.createElement("p");s.className="bdf-progress",s.textContent=`Step ${t.position} of ${t.total}`,e.querySelector(".bdv-header")?.prepend(s);let l=document.createElement("div");if(l.className="bdv-actions",t.canGoBack){let u=He(i.type==="message"?"Back":i.backLabel??"Back","bdv-cancel bdf-back");u.addEventListener("click",n),l.appendChild(u)}let c=i.continueLabel??(t.hasNext?"Continue":"Submit"),d=He(c,"bdv-submit");d.addEventListener("click",r),l.appendChild(d),e.appendChild(l)}function _o(e){let t=Ve(e.title??"Add a screenshot",e.description??(e.mode==="required"?"A screenshot is required before submitting.":"Include a screenshot to help explain your feedback."));if(e.mode==="optional"){let n=document.createElement("label");n.className="bdf-checkbox";let r=document.createElement("input");r.type="checkbox",r.checked=!0,r.dataset.screenshot="",n.append(r,document.createTextNode("Include a screenshot")),t.appendChild(n)}return t}function Ve(e,t){let n=document.createElement("section");n.className="bdv-surface";let r=document.createElement("div");r.className="bdv-header";let o=document.createElement("h2");o.className="bdv-title",o.textContent=e;let i=document.createElement("p");return i.className="bdv-description",i.textContent=t,r.append(o,i),n.appendChild(r),n}function Ho(e,t,n,r){let o=Ve("Submission failed",e),i=document.createElement("div");i.className="bdv-actions";let a=He("Try again","bdv-submit");a.addEventListener("click",n);let s=He(t,"bdv-cancel");return s.addEventListener("click",r),i.append(a,s),o.appendChild(i),o}function Vo(e,t,n){let r=Ve(e.config.content?.successTitle??"Thanks for your feedback!",e.config.content?.successMessage??"Your response was submitted.");if(t.isPublic){let i=document.createElement("a");i.className="bdv-success-link",i.href=t.issueUrl,i.target="_blank",i.rel="noopener noreferrer",i.textContent="View GitHub Issue",r.appendChild(i)}let o=He("Done","bdv-submit");return o.addEventListener("click",n),r.appendChild(o),r}function Uo(e){return e.querySelector("input:not(:disabled), textarea:not(:disabled), button:not(:disabled), a[href]")}function qo(){let e=document.activeElement;for(;e instanceof HTMLElement&&e.shadowRoot?.activeElement;)e=e.shadowRoot.activeElement;return e instanceof HTMLElement?e:null}function Wo(e){return Array.from(e.querySelectorAll('button:not(:disabled), input:not(:disabled), textarea:not(:disabled), a[href], [tabindex]:not([tabindex="-1"])')).filter(t=>!t.hidden&&t.getAttribute("aria-hidden")!=="true")}function He(e,t){let n=document.createElement("button");return n.type="button",n.className=t,n.textContent=e,n}function jo(e,t){let n={id:t.id,presentation:t.presentation,appearance:t.appearance,content:{title:t.id},fields:[{id:"placeholder",type:"shortText",label:"Placeholder"}],issue:{title:t.id}},r=Oe(e,n,"modal"),o=document.createElement("style");return o.textContent=`
    ...
    .bdf-back { order: -1; }
  `,e.prepend(o),{root:r.root,dispose(){o.remove(),r.dispose()}}}function Go(e,t,n){let r=qt(e,t);return ze(),new Cn(e,r,n).open()}var Cn=class{constructor(t,n,r){this.definition=t;this.ports=r;this.instanceId=Q(t.flowId),this.previousFocus=qo(),this.runtime=new Ne(t,n.context,n.initialAnswers),this.result=new Promise(o=>{this.resolveOutcome=o}),this.state=No(t.flowId,this.instanceId,o=>jo(o,t.config),o=>this.onKeydown(o),o=>this.onBackdrop(o))}definition;ports;instanceId;previousFocus;runtime;result;resolveOutcome;state;currentForm=null;settled=!1;closed=!1;busy=!1;routePreviewVersion=0;preflightVersion=0;captureAbortController=null;open(){let t=Object.freeze({instanceId:this.instanceId,result:this.result,close:()=>this.close()});this.state.activate(t.close);let n=Ve("Preparing feedback","Checking installation\u2026");return n.setAttribute("aria-busy","true"),this.show(n),this.preflight(),t}async preflight(){let t=++this.preflightVersion;try{let n=await this.ports.preflight();if(this.closed||t!==this.preflightVersion)return;if(n.status==="installed")this.render();else{let r=n.status==="not_installed"?`Install the ${n.appName??"BugDrop"} GitHub App to continue.`:"BugDrop could not reach the feedback service.";this.renderError(r,()=>{this.preflight()})}}catch{!this.closed&&t===this.preflightVersion&&this.renderError("BugDrop could not reach the feedback service.",()=>{this.preflight()})}}render(){this.disposeForm();let t=this.runtime.route(),n=t.screen;if(!n){this.finish();return}let r;if(n.type==="message")r=Oo(n);else if(n.type==="form"){let o=this.definition.config.forms.find(i=>i.id===n.form);this.currentForm=$o(o,this.instanceId,this.runtime.answers),r=this.currentForm.element}else r=_o(n);if(Sn(r,this.instanceId,this.definition.config.presentation.size??"default"),Bo(r,t,()=>{this.back(n)},()=>{this.advance(n,r)},()=>this.close()),n.type==="form"){let o=()=>{this.previewFormRoute(n.form,r)};r.addEventListener("input",o),r.addEventListener("change",o)}this.show(r)}async previewFormRoute(t,n){let r=++this.routePreviewVersion,o=await this.currentForm?.snapshot();if(!o||r!==this.routePreviewVersion||!n.isConnected||this.closed)return;this.runtime.setFormAnswers(t,o);let i=this.runtime.route(),a=i.screen;if(!a)return;let s=n.querySelector(".bdf-progress");s&&(s.textContent=`Step ${i.position} of ${i.total}`);let l=n.querySelector(".bdv-submit");l&&(l.textContent=a.continueLabel??(i.hasNext?"Continue":"Submit"))}async back(t){if(!this.busy){if(this.busy=!0,t.type==="form"){let n=await this.currentForm?.snapshot();if(n===null||this.closed){this.busy=!1;return}n&&this.runtime.setFormAnswers(t.form,n)}this.runtime.back(),this.busy=!1,this.render()}}async advance(t,n){if(!this.busy){if(this.busy=!0,t.type==="form"){let r=await this.currentForm?.collect();if(!r||this.closed){this.busy=!1;return}this.runtime.setFormAnswers(t.form,r)}if(t.type==="screenshot"){this.busy=!1,await this.capture(t,n);return}this.runtime.next()?(this.busy=!1,this.render()):(this.busy=!1,await this.finish())}}async capture(t,n){let r=t.mode!=="optional"||!!n.querySelector("[data-screenshot]")?.checked;this.busy=!0,this.state.host.hidden=!0;let o=new AbortController;this.captureAbortController=o;try{let i=await this.ports.capture(t,r,o.signal);if(this.closed)return;if(i.returnToForm)this.runtime.back();else if(this.runtime.capture=i,!this.runtime.next()){this.busy=!1,await this.finish();return}}finally{this.captureAbortController===o&&(this.captureAbortController=null),this.busy=!1,this.state.host.hidden=!1}this.closed||this.render()}async finish(){if(this.busy||this.closed)return;this.busy=!0;let t=Ve("Submitting feedback","Submitting\u2026");t.setAttribute("aria-busy","true"),this.show(t);try{let n=await this.ports.submit(this.runtime);if(this.closed)return;this.settle({status:"submitted",result:n}),this.busy=!1,this.show(Vo(this.definition,n,()=>this.close(!1)))}catch(n){if(this.closed)return;this.busy=!1,this.renderError(n instanceof Error?n.message:"Failed to submit feedback",()=>{this.finish()})}}renderError(t,n){this.show(Ho(t,this.definition.config.content?.cancelLabel??"Cancel",n,()=>this.close()))}show(t){Sn(t,this.instanceId,this.definition.config.presentation.size??"default"),this.state.overlay.replaceChildren(t),queueMicrotask(()=>(Uo(t)??t).focus())}close(t=!0){this.closed||(this.closed=!0,this.preflightVersion+=1,this.captureAbortController?.abort(),this.captureAbortController=null,t&&this.settle({status:"closed"}),this.disposeForm(),this.state.dispose(),this.previousFocus?.isConnected&&this.previousFocus.focus())}settle(t){this.settled||(this.settled=!0,this.resolveOutcome(t))}disposeForm(){this.routePreviewVersion+=1,this.currentForm?.dispose(),this.currentForm=null}onKeydown(t){if(!(t instanceof KeyboardEvent))return;if(t.key==="Escape"){t.preventDefault(),this.close();return}if(t.key!=="Tab")return;let n=Wo(this.state.overlay);if(!n.length){t.preventDefault(),this.state.overlay.querySelector('[role="dialog"]')?.focus();return}let r=n[0],o=n.at(-1),i=this.state.shadow.activeElement;t.shiftKey&&(i===r||!this.state.overlay.contains(i))?(t.preventDefault(),o.focus()):!t.shiftKey&&i===o&&(t.preventDefault(),r.focus())}onBackdrop(t){t.target===this.state.overlay&&this.close()}};function Ko(e,t,n){let r=bc(e.issue.title,t).trim().slice(0,256);if(!r)throw new TypeError("BugDrop flow Issue title cannot be empty");let o=(e.issue.sections??[]).map(i=>gc(e,i,t,n)).filter(i=>i!==null);return{title:r,description:o.join(`

`),category:e.issue.classification??"bug"}}function bc(e,t){return e.replace(/{{\s*([^{}]+?)\s*}}/g,(n,r)=>Yo(t[r.trim()]))}function gc(e,t,n,r){let o="answer"in t?n[t.answer]:r[t.context];if(t.omitWhenEmpty&&(o==null||o===""))return null;let i=fc(e,t,o);return`## ${t.heading}

${i}`}function fc(e,t,n){let r=t.format,o=Yo(n);if(r==="quote")return o.split(`
`).map(i=>`> ${i}`).join(`
`);if(r==="code")return hc(o);if(r==="stars"&&typeof n=="number"&&"answer"in t){let i=Xo(e,t.answer),a=i?.type==="rating"?i.scale??5:5;return`${"\u2605".repeat(n)}${"\u2606".repeat(Math.max(0,a-n))} (${n}/${a})`}if(r==="choice"&&typeof n=="string"&&"answer"in t){let i=Xo(e,t.answer);if(i?.type==="singleChoice")return i.options.find(a=>a.value===n)?.label??o}return o}function hc(e){let t=Math.max(0,...[...e.matchAll(/`+/g)].map(o=>o[0].length)),n="`".repeat(t+1),r=e.startsWith("`")||e.endsWith("`")?" ":"";return`${n}${r}${e}${r}${n}`}function Xo(e,t){let n=t.indexOf("."),r=t.slice(0,n),o=t.slice(n+1);return e.forms.find(i=>i.id===r)?.fields.find(i=>i.id===o)}function Yo(e){return e==null?"":typeof e=="string"?e.trim():String(e)}async function Jo(e,t,n,r,o){let i=Ko(t,n,r),a=t.evidence?.attachments,s=t.evidence?.sendConsoleLogs,l=t.evidence?.submitter?.name,c=t.evidence?.submitter?.email,d=l||c?{name:Zo(n[l??""]),email:Zo(n[c??""])}:void 0,u=await fetch(`${e.apiUrl}/feedback`,{method:"POST",headers:{"Content-Type":"application/json",...await he(e.authTokenProvider)},body:JSON.stringify({repo:e.repo,title:i.title,description:i.description,category:i.category,categoryLabels:e.categoryLabels,screenshot:o?.screenshot??null,attachments:a?n[a]??[]:[],consoleLogs:s&&n[s]===!0?Rt():void 0,submitter:d&&(d.name||d.email)?d:void 0,metadata:wc(o)})});if(u.status===429)throw new Error("Too many submissions. Please try again later.");let f=await u.json();if(!u.ok||f.success!==!0)throw new Error(typeof f.error=="string"?f.error:"Failed to submit feedback");if(!Number.isInteger(f.issueNumber)||f.issueNumber<=0||typeof f.issueUrl!="string"||typeof f.isPublic!="boolean"||!yc(f.issueUrl,e.repo,f.issueNumber))throw new Error("BugDrop received an invalid Issue result");return{issueNumber:f.issueNumber,issueUrl:f.issueUrl,isPublic:f.isPublic,...Array.isArray(f.labelMappingWarnings)&&f.labelMappingWarnings.every(m=>typeof m=="string")?{labelMappingWarnings:f.labelMappingWarnings}:{}}}function yc(e,t,n){try{let r=new URL(e);return r.origin==="https://github.com"&&r.pathname.toLowerCase()===`/${t}/issues/${n}`.toLowerCase()&&!r.search&&!r.hash}catch{return!1}}function wc(e){let t=new URL(window.location.href);return t.search="",t.hash="",{url:t.toString(),userAgent:navigator.userAgent,viewport:{width:window.innerWidth,height:window.innerHeight},timestamp:new Date().toISOString(),elementSelector:e?.elementSelector??null,fullElementSelector:e?.fullElementSelector??null,domNodeCount:Re(),fullPageDisabled:ne(),devicePixelRatio:window.devicePixelRatio,language:navigator.language}}function Zo(e){return typeof e=="string"&&e.trim()?e.trim():void 0}function Qo(e,t,n={isLegacyModalOpen:()=>!1}){let r=new Map;return{register(o){let i=Wt(o);if(r.has(i.id))throw new TypeError(`BugDrop flow is already registered: ${i.id}`);let a=Ht(i);return r.set(i.id,a),Object.freeze({id:i.id,open(s){return n.isLegacyModalOpen()?(qt(a,s),Ro(i.id)):Go(a,s,{...t,submit:l=>Jo(e,i,l.answers,l.context,l.capture)})}})}}}var lt="bugdrop_dismissed",vc="bugdrop_trigger_position_",si="bugdrop_welcomed_",xc="bugdrop_complex_screenshot_skipped_",Ec=10080*60*1e3,it=8,ei=16,ti=5,ni=5*1024*1024,li=["image/png","image/jpeg","image/gif","image/webp","application/pdf","video/mp4","video/webm","video/quicktime"];function kc(e){let t=[{name:"Edge",pattern:/Edg(?:e|A|iOS)?\/(\d+[\d.]*)/},{name:"Opera",pattern:/(?:OPR|Opera)\/(\d+[\d.]*)/},{name:"Chrome",pattern:/Chrome\/(\d+[\d.]*)/},{name:"Safari",pattern:/Version\/(\d+[\d.]*).*Safari/},{name:"Firefox",pattern:/Firefox\/(\d+[\d.]*)/}];for(let{name:n,pattern:r}of t){let o=e.match(r);if(o)return{name:n,version:o[1]||"unknown"}}return{name:"Unknown",version:"unknown"}}function Sc(e){let t=[{name:"iOS",pattern:/iPhone OS (\d+[_\d]*)/,versionIndex:1},{name:"iOS",pattern:/iPad.*OS (\d+[_\d]*)/,versionIndex:1},{name:"macOS",pattern:/Mac OS X (\d+[_.\d]*)/,versionIndex:1},{name:"Windows",pattern:/Windows NT (\d+\.\d+)/,versionIndex:1},{name:"Android",pattern:/Android (\d+[\d.]*)/,versionIndex:1},{name:"Linux",pattern:/Linux/,versionIndex:void 0},{name:"Chrome OS",pattern:/CrOS/,versionIndex:void 0}];for(let{name:n,pattern:r,versionIndex:o}of t){let i=e.match(r);if(i){let a=o!==void 0&&i[o]?i[o].replace(/_/g,"."):"";return{name:n,version:a}}}return{name:"Unknown",version:""}}function ci(e){try{let t=new URL(e);return`${t.origin}${t.pathname}`}catch{return e.split("?")[0].split("#")[0]}}function Cc(){let e=navigator.userAgent;return{browser:kc(e),os:Sc(e),devicePixelRatio:window.devicePixelRatio||1,language:navigator.language||"unknown",url:ci(window.location.href)}}var Tc=null,X=null,at=null,K=!1,Lc=null,Ue=!1;function ri(e){try{let t=localStorage.getItem(lt);if(!t)return!1;if(t==="true")return!0;let n=parseInt(t,10);if(isNaN(n))return!1;if(e===void 0)return!0;let r=e*24*60*60*1e3;return Date.now()-n<r}catch{return!1}}function di(){try{localStorage.setItem(lt,Date.now().toString())}catch{}}function ui(e){try{return localStorage.getItem(si+e)!==null}catch{return!1}}function pi(e){try{localStorage.setItem(si+e,Date.now().toString())}catch{}}function Mn(e){return`${xc}${e}:${ci(window.location.href)}`}function Fc(e){try{let t=Mn(e),n=localStorage.getItem(t);if(!n)return!1;let r=parseInt(n,10);return isNaN(r)||Date.now()-r>Ec?(localStorage.removeItem(t),!1):!0}catch{return!1}}function Ac(e){try{localStorage.setItem(Mn(e),Date.now().toString())}catch{}}function Pc(e){try{localStorage.removeItem(Mn(e))}catch{}}function mi(e,t){ne()&&(Ac(e.repo),t.includeScreenshot=!1)}function Rc(e){if(!e)return;let t;try{t=JSON.parse(e)}catch(o){let i=o instanceof Error?`: ${o.message}`:"";console.warn(`[BugDrop] Invalid data-category-labels JSON${i}. Using default GitHub labels.`);return}if(!t||typeof t!="object"||Array.isArray(t)){console.warn("[BugDrop] Invalid data-category-labels: expected a JSON object. Using default GitHub labels.");return}let n=["bug","feature","question"],r={};for(let[o,i]of Object.entries(t)){if(!n.includes(o)){console.warn(`[BugDrop] Invalid data-category-labels: unknown category "${o}" (expected ${n.join(", ")}). Ignoring.`);continue}typeof i=="string"||Array.isArray(i)&&i.every(a=>typeof a=="string")?r[o]=i:console.warn(`[BugDrop] Invalid data-category-labels: value for "${o}" must be a string or string array. Ignoring.`)}return Object.keys(r).length>0?r:void 0}var M=document.currentScript||document.querySelector('script[src*="bugdrop"][src*="widget"]');document.currentScript||console.warn("[BugDrop] document.currentScript is null \u2014 do not use async or defer on the BugDrop script tag.");var st=M?.dataset.theme;st&&!Et(st)&&console.warn(`[BugDrop] Invalid data-theme "${st}". Expected "light", "dark", or "auto".`);var Mc=cr(M?.dataset.locale||document.documentElement.lang),oi=M?.dataset.requireName==="true",ii=M?.dataset.requireEmail==="true",rt=M?.dataset.position;rt&&rt!=="bottom-right"&&rt!=="bottom-left"&&console.warn(`[BugDrop] Invalid data-position "${rt}". Expected "bottom-right" or "bottom-left".`);var bi=M?.dataset.dismissDuration,gi=sr(bi);bi&&gi===void 0&&console.warn("[BugDrop] Invalid data-dismiss-duration. Expected a positive whole number of days.");var fi=M?.dataset.screenshotScale,hi=tn(fi);fi&&hi===void 0&&console.warn("[BugDrop] Invalid data-screenshot-scale. Expected a non-negative number.");var yi=M?.dataset.elementContextMaxArea,wi=tn(yi);yi&&wi===void 0&&console.warn("[BugDrop] Invalid data-element-context-max-area. Expected a non-negative number.");var vi=M?.dataset.shadow,xi=pt(vi);vi&&!xi&&console.warn('[BugDrop] Invalid data-shadow. Expected "soft", "hard", or "none".');var Ee=M?.dataset.showIssueLink,Ei=Ee==="always"||Ee==="never"?Ee:"public";Ee&&Ee!=="public"&&Ee!==Ei&&console.warn(`[BugDrop] Invalid data-show-issue-link "${Ee}". Expected "public", "always", or "never".`);var ot={repo:M?.dataset.repo||"",apiUrl:M?.src.replace(/\/widget(?:\.v[\d.]+)?\.js$/,"/api")||"",authTokenProvider:Kr(M?.dataset.authTokenProvider),position:rt==="bottom-left"?"bottom-left":"bottom-right",theme:Et(st)?st:"auto",showName:M?.dataset.showName==="true"||oi,requireName:oi,showEmail:M?.dataset.showEmail==="true"||ii,requireEmail:ii,buttonDismissible:M?.dataset.buttonDismissible==="true",dismissDuration:gi,showRestore:M?.dataset.showRestore!=="false",showButton:M?.dataset.button!=="false",accentColor:_(M?.dataset.color),iconUrl:je(M?.dataset.icon),label:M?.dataset.label||void 0,categoryLabels:Rc(M?.dataset.categoryLabels),font:Ae(M?.dataset.font),radius:J(M?.dataset.radius)?.toString(),bgColor:_(M?.dataset.bg),textColor:_(M?.dataset.text),borderWidth:J(M?.dataset.borderWidth)?.toString(),borderColor:_(M?.dataset.borderColor),shadow:xi,welcome:(()=>{let e=M?.dataset.welcome;return e==="false"||e==="never"?"never":e==="always"?"always":"once"})(),screenshotMode:(()=>{let e=M?.dataset.screenshot;return e==="auto"||e==="required"?e:(e&&e!=="optional"&&console.warn(`[BugDrop] Invalid data-screenshot "${e}". Expected "optional", "auto", or "required".`),"optional")})(),screenshotScale:hi,elementContextMaxArea:wi,issueLinkVisibility:Ei,sendConsoleLogs:M?.dataset.sendConsoleLogs==="true",locale:Mc};ur(ot.locale);Jr();ot.repo?/^[^/]+\/[^/]+$/.test(ot.repo)?zc(ot):console.error(`[BugDrop] Invalid data-repo format "${ot.repo}". Expected "owner/repo" (e.g., "octocat/hello-world").`):console.error("[BugDrop] Missing data-repo attribute");function Dc(e){return e.label!==void 0?e.label:p().triggerLabel}function ki(e,t){if(t.position==="bottom-left"&&e.appendChild(ai()),t.iconUrl!=="none"){let r=document.createElement("span");if(r.className="bd-trigger-icon",t.iconUrl){let o=document.createElement("img");o.src=t.iconUrl,o.alt="";let i=document.createElement("span");i.textContent="\u{1F41B}",i.style.display="none",o.addEventListener("error",()=>{o.style.display="none",i.style.display=""}),r.append(o,i)}else r.textContent="\u{1F41B}";e.appendChild(r)}let n=document.createElement("span");n.className="bd-trigger-label",n.textContent=Dc(t),e.appendChild(n),t.position!=="bottom-left"&&e.appendChild(ai())}function ai(){let e=document.createElement("span");return e.className="bd-trigger-drag-handle",e.setAttribute("aria-hidden","true"),e.title=p().dragHandleTitle,e.innerHTML=`
  ...
  `,e}function Si(e,t=!1){let n=["bd-trigger",`bd-trigger--${e.position==="bottom-left"?"left":"right"}`];return t&&n.push("bd-trigger--restoring"),n.join(" ")}function Ci(e){return`${vc}${e.repo}_${e.position}`}function Ti(e){try{let t=localStorage.getItem(Ci(e));if(!t)return null;let n=Number(t);return Number.isFinite(n)?n:null}catch{return null}}function Li(e,t){try{localStorage.setItem(Ci(e),String(Math.round(t)))}catch{}}function Ic(e,t){let n=e.getBoundingClientRect(),r=Math.max(it,window.innerHeight-n.height-it);return Math.min(Math.max(t,it),r)}function jt(e,t){let n=Ic(e,t);return e.style.top=`${n}px`,e.style.bottom="auto",n}function Fi(e,t){let n=Ti(t);n!==null&&(e.classList.add("bd-trigger--positioned"),jt(e,n))}function An(e,t){if(!e.style.top)return;let n=e.getBoundingClientRect();if(n.width===0||n.height===0)return;let r=parseFloat(e.style.top);if(!Number.isFinite(r))return;let o=e.classList.contains("bd-trigger--dragging")?r:Ti(t)??r;jt(e,o)}function Ai(e,t){let n=()=>{if(!e.isConnected){r();return}An(e,t)},r=()=>{window.removeEventListener("resize",n),window.visualViewport?.removeEventListener("resize",n)};window.addEventListener("resize",n),window.visualViewport?.addEventListener("resize",n)}function Pi(e,t){let n=e.querySelector(".bd-trigger-drag-handle");if(!n)return;let r=null,o=0,i=0,a=!1,s=()=>{r!==null&&(r=null,e.classList.remove("bd-trigger--dragging"),window.removeEventListener("pointermove",l),window.removeEventListener("pointerup",c),window.removeEventListener("pointercancel",d),a&&(Li(t,e.getBoundingClientRect().top),window.setTimeout(()=>{Ue=!1},0)))};function l(u){if(r!==u.pointerId)return;let f=i+u.clientY-o;Math.abs(u.clientY-o)>3&&(a=!0,Ue=!0),jt(e,f)}function c(u){r===u.pointerId&&s()}function d(u){r===u.pointerId&&s()}n.addEventListener("pointerdown",u=>{u.preventDefault(),u.stopPropagation();let f=e.getBoundingClientRect();r=u.pointerId,o=u.clientY,i=f.top,a=!1,e.classList.add("bd-trigger--dragging"),n.setPointerCapture(u.pointerId),window.addEventListener("pointermove",l),window.addEventListener("pointerup",c),window.addEventListener("pointercancel",d)}),n.addEventListener("click",u=>{u.preventDefault(),u.stopPropagation()})}function Ri(e,t){e.addEventListener("keydown",n=>{if(n.target!==e||!["ArrowUp","ArrowDown","Home","End"].includes(n.key))return;n.preventDefault(),n.stopPropagation();let r=e.getBoundingClientRect(),o=window.innerHeight-r.height-it,i=n.key==="ArrowUp"?r.top-ei:n.key==="ArrowDown"?r.top+ei:n.key==="Home"?it:o;e.classList.add("bd-trigger--positioned"),Li(t,jt(e,i))})}function Pn(e,t){let n=document.createElement("div");n.className=t.position==="bottom-left"?"bd-pull-tab bd-pull-tab--left":"bd-pull-tab",n.innerHTML='<span class="bd-pull-tab-chevron">\u2039</span>',n.setAttribute("role","button"),n.setAttribute("tabindex","0"),n.setAttribute("aria-label",p().pullTabAriaLabel);let r=()=>{try{localStorage.removeItem(lt)}catch{}n.remove(),at=null,Mi(e,t,!0)};return n.addEventListener("click",r),n.addEventListener("keydown",o=>{(o.key==="Enter"||o.key===" ")&&(o.preventDefault(),r())}),e.appendChild(n),at=n,n}function zc(e){if(Lc=e,!e.buttonDismissible)try{localStorage.removeItem(lt)}catch{}let t=document.createElement("div");t.id="bugdrop-host",t.style.pointerEvents="auto",document.body.appendChild(t);let n=t.attachShadow({mode:"open"});de(t);for(let i of["keydown","keypress","keyup"])n.addEventListener(i,a=>{let s=a.target;(s.tagName==="INPUT"||s.tagName==="TEXTAREA")&&a.stopPropagation()});let r=Ir(n,e);if(Tc=r,e.showButton&&!(e.buttonDismissible&&ri(e.dismissDuration))){let i=document.createElement("button");if(i.className=Si(e),ki(i,e),i.setAttribute("aria-label",p().triggerAriaLabel),e.buttonDismissible){let a=document.createElement("button");a.className="bd-trigger-close",a.textContent="\xD7",a.setAttribute("aria-label",p().dismissButtonAriaLabel),i.appendChild(a),a.addEventListener("click",s=>{s.stopPropagation(),di(),i.classList.remove("bd-trigger--restoring"),i.classList.add("bd-trigger--dismissing"),i.addEventListener("animationend",()=>{i.remove(),X=null,e.showRestore&&Pn(r,e)},{once:!0})})}r.appendChild(i),X=i,Fi(i,e),Ai(i,e),Pi(i,e),Ri(i,e),i.addEventListener("click",()=>{if(Ue){Ue=!1;return}Dn(r,e)})}else e.showButton&&e.buttonDismissible&&e.showRestore&&ri(e.dismissDuration)&&Pn(r,e);$c(r,e),window.dispatchEvent(new CustomEvent("bugdrop:ready"))}function $c(e,t){let n=t.theme,r,o;window.BugDrop={open:()=>{K||Dn(e,t,{skipWelcome:!0})},close:()=>{if(K){let i=e.querySelector(".bd-modal");i&&i.remove(),K=!1}},hide:()=>{X&&(X.style.display="none")},show:()=>{try{localStorage.removeItem(lt)}catch{}at&&(at.remove(),at=null),X?(X.style.display="",An(X,t),window.requestAnimationFrame(()=>{X&&An(X,t)})):t.showButton&&Mi(e,t)},isOpen:()=>K,isButtonVisible:()=>X!==null&&X.style.display!=="none",setTheme:i=>{if(!Et(i)){console.warn(`[BugDrop] Invalid theme ${String(i)}. Expected 'light' | 'dark' | 'auto'.`);return}n=i;let a=De(i);Ye(e,a),Ze(e,t,a)},registerVariant:i=>(r??=yo({repo:t.repo,apiUrl:t.apiUrl,authTokenProvider:t.authTokenProvider},{isLegacyModalOpen:()=>K}),r.register(i)),registerFlow:i=>(o??=Qo({repo:t.repo,apiUrl:t.apiUrl,authTokenProvider:t.authTokenProvider,categoryLabels:t.categoryLabels},{preflight:()=>In(t),capture:async(a,s,l)=>await Lt(e,{...t,screenshotMode:a.mode},s,()=>{},l)},{isLegacyModalOpen:()=>K}),o.register(i))},kt(i=>{n==="auto"&&(Ye(e,i),Ze(e,t,i))})}function Mi(e,t,n=!1){let r=document.createElement("button");if(r.className=Si(t,n),ki(r,t),r.setAttribute("aria-label",p().triggerAriaLabel),t.buttonDismissible){let o=document.createElement("button");o.className="bd-trigger-close",o.textContent="\xD7",o.setAttribute("aria-label",p().dismissButtonAriaLabel),r.appendChild(o),o.addEventListener("click",i=>{i.stopPropagation(),di(),r.classList.remove("bd-trigger--restoring"),r.classList.add("bd-trigger--dismissing"),r.addEventListener("animationend",()=>{r.remove(),X=null,t.showRestore&&Pn(e,t)},{once:!0})})}e.appendChild(r),X=r,Fi(r,t),Ai(r,t),Pi(r,t),Ri(r,t),r.addEventListener("click",()=>{if(Ue){Ue=!1;return}Dn(e,t)})}async function Dn(e,t,n){if(K)return;ze(),K=!0;let r=void 0;if(r==="private"||r!=="fixed"&&!0){if(await Nc(e,t,n)==="preflight-blocked")return}else{let{status:i,appName:a}=await In(t);if(i==="not_installed"){Rn(e,t,void 0,a);return}if(i==="unreachable"){Rn(e,t,p().apiUnreachableMessage,a);return}await Oc(e,t,n)}K=!1}async function Oc(e,t,n){if(!(n?.skipWelcome||t.welcome==="never"||t.welcome==="once"&&ui(t.repo))){if(!await Di(e)){K=!1;return}t.welcome==="once"&&pi(t.repo)}let o=null;for(;;){if(o=await Ii(e,t,o),!o){K=!1;return}let i=o,a=await Lt(e,t,i.includeScreenshot,()=>mi(t,i));if(!a.returnToForm){await zn(e,t,{title:o.title,description:o.description,category:o.category,name:o.name,email:o.email,screenshot:a.screenshot,attachments:o.attachments,elementSelector:a.elementSelector,fullElementSelector:a.fullElementSelector,selectedElementHighlightColor:a.elementSelector?ge(t.accentColor):null,sendConsoleLogs:o.sendConsoleLogs});break}}}async function Nc(e,t,n){let r=Po({repo:t.repo,apiUrl:t.apiUrl,authTokenProvider:t.authTokenProvider,welcome:t.welcome,screenshotMode:t.screenshotMode,skipWelcome:!!n?.skipWelcome,hasSeenWelcome:ui(t.repo),showName:t.showName,requireName:t.requireName,showEmail:t.showEmail,requireEmail:t.requireEmail,sendConsoleLogs:t.sendConsoleLogs,screenshotScale:t.screenshotScale,elementContextMaxArea:t.elementContextMaxArea,accentColor:t.accentColor,categoryLabels:t.categoryLabels,issueLinkVisibility:t.issueLinkVisibility});return vo(r,{preflight:o=>In({...t,repo:o.repo,apiUrl:o.apiUrl,authTokenProvider:o.authTokenProvider}),showPreflightFailure:o=>Rn(e,t,o.status==="unreachable"?p().apiUnreachableMessage:void 0,o.appName),showWelcome:()=>Di(e),rememberWelcome:()=>pi(r.steps[1].repo),showDetails:(o,i)=>Ii(e,{...t,repo:o.repo,showName:o.showName,requireName:o.requireName,showEmail:o.showEmail,requireEmail:o.requireEmail,sendConsoleLogs:o.sendConsoleLogs,screenshotMode:r.steps[2].mode},i),capture:async(o,i)=>{let a={...t,repo:o.repo,screenshotMode:o.mode,screenshotScale:o.screenshotScale,elementContextMaxArea:o.elementContextMaxArea,accentColor:o.accentColor},s=await Lt(e,a,i.includeScreenshot,()=>mi(a,i));return{...s,returnToDetails:s.returnToForm}},submit:(o,i,a)=>zn(e,{...t,repo:o.repo,apiUrl:o.apiUrl,authTokenProvider:o.authTokenProvider,categoryLabels:o.categoryLabels,issueLinkVisibility:o.issueLinkVisibility},{title:i.title,description:i.description,category:i.category,name:i.name,email:i.email,screenshot:a.screenshot,attachments:i.attachments,elementSelector:a.elementSelector,fullElementSelector:a.fullElementSelector,selectedElementHighlightColor:a.elementSelector?ge(t.accentColor):null,sendConsoleLogs:i.sendConsoleLogs})})}async function In(e){try{let t=await fetch(`${e.apiUrl}/check/${e.repo}`,{headers:await he(e.authTokenProvider)});if(!t.ok)return{status:"unreachable"};let n=await t.json();return{status:n.installed===!0?"installed":"not_installed",appName:n.appName}}catch{return{status:"unreachable"}}}function Rn(e,t,n,r){let i=`https://github.com/apps/${r||(t.apiUrl.includes("bugdrop.neonwatty.workers.dev")?"neonwatty-bugdrop":t.apiUrl.replace(/https?:\/\//,"").replace(/\..*/,""))}/installations/new`,a=n||p().installRequiredMessage,s=n?p().connectionErrorTitle:p().installRequiredTitle,l=V(e,s,`
    ...
    `,!0),c=l.querySelector(".bd-close"),d=l.querySelector('[data-action="cancel"]');c?.addEventListener("click",()=>{l.remove(),K=!1}),d?.addEventListener("click",()=>{l.remove(),K=!1})}function Di(e){return new Promise(t=>{let n=V(e,p().welcomeTitle,`
      ...
      `,!0),r=n.querySelector(".bd-close"),o=n.querySelector('[data-action="continue"]');r?.addEventListener("click",()=>{n.remove(),t(!1)}),o?.addEventListener("click",()=>{n.remove(),t(!0)})})}function Ii(e,t,n){return new Promise(r=>{let o=t.showName?`
          <div class="bd-form-group">
            ...
            <input type="text" id="name" class="bd-input" ${t.requireName?"required":""} placeholder="${x(p().namePlaceholder)}" value="${q(n?.name||"")}" />
          </div>
        `:"",i=t.showEmail?`
          <div class="bd-form-group">
            <label class="bd-label" for="email">${x(p().emailLabel)}${t.requireEmail?" *":""}</label>
            <input type="email" id="email" class="bd-input" ${t.requireEmail?"required":""} placeholder="${x(p().emailPlaceholder)}" value="${q(n?.email||"")}" />
          </div>
        ...
        <form id="feedback-form">
          ...
          <div class="bd-form-group">
            ...
            <input type="text" id="title" class="bd-input" required placeholder="${x(p().titlePlaceholder)}" value="${q(n?.title||"")}" />
          </div>
          <div class="bd-form-group">
            <label class="bd-label" for="description">${x(p().descriptionLabel)}</label>
            <textarea id="description" class="bd-textarea" placeholder="${x(p().descriptionPlaceholder)}">${q(n?.description||"")}</textarea>
          </div>
          ${o}
          ${i}
      ...
      `),s=a.querySelector("#feedback-form"),l=a.querySelector("#name"),c=a.querySelector("#email"),d=a.querySelector("#title"),u=a.querySelector("#description"),f=a.querySelector("#include-screenshot"),m=a.querySelector("#attachment-upload"),g=a.querySelector('[data-action="choose-uploads"]'),h=a.querySelector("#attachment-list"),E=a.querySelector("#attachment-error"),C=a.querySelector("#send-console-logs"),F=a.querySelector(".bd-close"),P=a.querySelector('[data-action="cancel"]'),L=[...n?.attachments??[]],D=()=>{a.remove(),r(null)};F?.addEventListener("click",D),P?.addEventListener("click",D),s.addEventListener("submit",A=>{if(A.preventDefault(),!d.value.trim()){d.classList.add("bd-input--error"),d.focus();return}if(t.requireName&&l&&!l.value.trim()){l.classList.add("bd-input--error"),l.focus();return}if(t.requireEmail&&c&&!c.value.trim()){c.classList.add("bd-input--error"),c.focus();return}let I=a.querySelector('input[name="category"]:checked')?.value||"bug",$=t.screenshotMode==="optional"?f?.checked??!1:!0;t.screenshotMode==="optional"&&$&&Pc(t.repo),a.remove(),r({title:d.value.trim(),description:u.value.trim(),category:I,name:l?.value.trim()||void 0,email:c?.value.trim()||void 0,includeScreenshot:$,attachments:L,sendConsoleLogs:C.checked})}),d.addEventListener("input",()=>d.classList.remove("bd-input--error")),l?.addEventListener("input",()=>l.classList.remove("bd-input--error")),c?.addEventListener("input",()=>c.classList.remove("bd-input--error"));let v=()=>{Hc(h,L,A=>{L=L.filter((z,I)=>I!==A),v()})};g.addEventListener("click",()=>m.click()),m.addEventListener("change",async()=>{let A=Array.from(m.files??[]);m.value="",E.textContent="",E.hidden=!0;let z=ti-L.length;if(A.length>z){Tn(E,p().uploadTooMany(ti));return}for(let I of A){let $=_c(I);if($){Tn(E,$);return}}try{let I=await Promise.all(A.map(Vc));L=[...L,...I],v()}catch{Tn(E,p().uploadReadError)}}),v()})}function Bc(){return`
  ...
  `}function _c(e){return li.includes(e.type)?e.size>ni?p().uploadTooLarge(zi(ni)):null:p().uploadUnsupportedType}function Tn(e,t){e.textContent=t,e.hidden=!1}function Hc(e,t,n){e.innerHTML=t.map((r,o)=>`
      ...
      `).join(""),e.querySelectorAll(".bd-upload-remove").forEach(r=>{r.addEventListener("click",()=>{let o=Number(r.dataset.index);Number.isInteger(o)&&n(o)})})}function Vc(e){return new Promise((t,n)=>{let r=new FileReader;r.addEventListener("load",()=>{if(typeof r.result!="string"){n(new Error("Could not read file."));return}t({name:e.name,type:e.type,size:e.size,dataUrl:r.result})}),r.addEventListener("error",()=>n(new Error("Could not read file."))),r.readAsDataURL(e)})}function zi(e){return e<1024?`${e} B`:e<1024*1024?`${Math.round(e/1024)} KB`:`${Math.round(e/(1024*1024)*10)/10} MB`}function Uc(e,t){if(e.screenshotMode==="auto"){let r=Me()>0?` ${x(p().screenshotAutoRedactionNote)}`:"";return`
