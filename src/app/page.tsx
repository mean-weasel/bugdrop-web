    ...
    <main>
      ...
      <section className="mx-auto max-w-5xl px-6 py-16" aria-labelledby="portable-resources">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          ...
          <Link href="/resources/screenshot-privacy-checklist" className="rounded-xl border border-border bg-bg-surface p-5 no-underline hover:border-accent-cyan">
            <strong className="text-text-primary">Screenshot privacy checklist</strong>
            <span className="mt-2 block text-text-subtle">Minimize capture scope, inspect redaction, verify the destination, and plan retention.</span>
          </Link>
        </div>
        <Link href="/resources" className="mt-6 inline-flex font-medium text-accent-cyan">Browse all website feedback resources</Link>
      </section>
      <TryCallout />
    </main>
  );
