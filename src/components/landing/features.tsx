...
export function Features() {
  return (
    <section className="mb-20">
      ...
      <div className="mt-6 text-center" data-acquisition-related-for="/">
        <Link
          href="/use-cases"
          data-acquisition-related-link="/use-cases"
          data-analytics-event="acquisition_path_click"
          data-analytics-label="Explore website feedback use cases"
