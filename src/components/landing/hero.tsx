...
import { GITHUB_REPO_URL, MARKETPLACE_URL, PRODUCT_HUNT_URL } from "@/lib/links";
  ...
  return (
    <header className="hero-layout">
      <div className="hero-copy">
        ...
        <h1 className="hero-title">From “it’s broken” to <strong>an actionable GitHub Issue.</strong></h1>
        <p className="hero-description">Collect screenshots, annotations, and browser context right from your website. Give your team the details to fix it.</p>
        <div className="hero-actions">
          <a href="#flows" data-homepage-hero-activate data-analytics-event="landing_cta_click" data-analytics-label="Try the widget" className="hero-primary">
        ...
        <p className="mt-3 text-xs text-text-subtle">One script tag · MIT licensed · Self-hostable</p>
      ...
      <div className="hero-proof">
        ...
        <a href={PRODUCT_HUNT_URL} target="_blank" rel="noopener noreferrer" aria-label="BugDrop was the number 6 Product of the Day on Product Hunt"><strong>#6</strong><span>Product of the Day</span></a>
