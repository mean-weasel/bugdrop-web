...
For a tool-independent review before capture, upload, and retention, use the
[Screenshot Privacy Checklist](/resources/screenshot-privacy-checklist). It is
printable and downloadable without JavaScript or a BugDrop installation.
