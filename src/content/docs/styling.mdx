...
| `data-shadow` | `"soft"` | Shadow preset for the form container: `"soft"`, `"hard"`, or `"none"` |
...
5. **Shadow depth signals importance** -- Use `data-shadow="hard"` when the widget should stand out, `soft` for the default layered look, or `none` for a flat interface
