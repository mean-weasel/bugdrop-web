...
When a defect is visual, use the [Visual Bug Report Template](/resources/visual-bug-report-template). A screenshot should identify the affected state, not replace expected behavior and reproduction steps.
