...
Read [screenshot configuration](/docs/configuration#screenshot-behavior), [masking limits](/docs/security#screenshot-masking), and [installation](/docs/installation) before launch.
